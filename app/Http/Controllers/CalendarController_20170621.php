...
class CalendarController extends Controller {
	...
	public function get_calendar(Request $request) {
        ...
        <div class="col-lg-4 col-sm-12 col-xs-12 ng-scope mt30"><i class="fa fa-caret-left" aria-hidden="true"></i><span class="side-text"> Select a date/range on calendar to modify pricing and availability<p></p></span></div>
