...
class Rooms extends Model
{
    ...
    public function getStepsCountAttribute()
    {
        ...
        return 10 - (@$result->basics + @$result->description + @$result->details + @$result->location + @$result->amenities + @$result->photos + @$result->pricing + @$result->calendar + @$result->booking + @$result->terms);
    }
    ...
    public function getStepsCompletedAttribute()
    {
        ...
        return (@$result->basics + @$result->description + @$result->details + @$result->location + @$result->amenities + @$result->photos + @$result->pricing + @$result->calendar + @$result->booking + @$result->terms);
    }
