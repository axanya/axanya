...
class Reservation extends Model
{
    ...
    protected $appends = [
        ...
        'checkout_mdy',
        'check_total',
        'checkin_site_date_format',
        'checkout_site_date_format',
        'review_end_date'
    ];
    ...
    {
        $start_date = $this->attributes['checkout'];
        $end_date   = date('d F', strtotime($this->attributes['checkout'] . ' +14 days'));
    ...
    public function getCheckTotalAttribute()
    {
      ...
      if($host_id == @Auth::user()->user()->id) return $this->currency_calc('total') + $this->currency_calc('coupon_amount') - $this->currency_calc('service');
      else
