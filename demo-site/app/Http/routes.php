...
Route::post('rooms/create', 'RoomsController@create');
    ...
    Route::group(['middleware' => 'manage_listing_auth'], function ()
    {
        ...
        Route::post('manage-listing/{id}/featured_image', 'RoomsController@featured_image');
...
// Cancel Reservation
    Route::match(['get', 'post'], 'trips/guest_cancel_pending_reservation',
        'TripsController@guest_cancel_pending_reservation');
...
Route::filter('guest', function() {
    if (Auth::user()->guest()) {
        ...
        if (strpos($request_url, '/payments/book/'))
        {
            ...
            if ($_POST)
            {
                Session::put('payment_room_id', $id);
                Session::put('payment_checkin', $_POST['checkin']);
                Session::put('payment_checkout', $_POST['checkout']);
                Session::put('payment_number_of_guests', $_POST['number_of_guests']);
                Session::put('payment_booking_type', $_POST['booking_type']);
            }
            if ($_GET)
            {
                Session::put('payment_room_id', $id);
                Session::put('payment_checkin', $_GET['checkin']);
                Session::put('payment_checkout', $_GET['checkout']);
                Session::put('payment_number_of_guests', $_GET['number_of_guests']);
                Session::put('payment_booking_type', $_GET['booking_type']);
            }
        }
...
// Manage Home Page Cities Routes
    ...
    Route::get('referral_details/{id}', 'Admin\ReferralsController@details');
...
// Manage Home Page Slider Routes
    ...
    Route::group(['before' => 'manage_home_page_sliders'], function ()
    {
        ...
        Route::match(['GET', 'POST'], 'add_slider', 'Admin\SliderController@add');

        Route::match(['GET', 'POST'], 'edit_slider/{id}', 'Admin\SliderController@update');
...
// Manage Home Page Bottom Slider Routes
    ...
    Route::group(['before' => 'manage_home_page_bottom_sliders'], function ()
    {
        ...
        Route::match(['GET', 'POST'], 'add_bottom_slider', 'Admin\BottomSliderController@add');

        Route::match(['GET', 'POST'], 'edit_bottom_slider/{id}', 'Admin\BottomSliderController@update');

        Route::get('delete_bottom_slider/{id}', 'Admin\BottomSliderController@delete');
...
// Manage Our Community Banners Routes
    ...
    Route::group(['before' => 'manage_our_community_banners'], function ()
    {
        ...
        Route::match(['GET', 'POST'], 'add_our_community_banners', 'Admin\OurCommunityBannersController@add');

        Route::match(['GET', 'POST'], 'edit_our_community_banners/{id}', 'Admin\OurCommunityBannersController@update');

        Route::get('delete_our_community_banners/{id}', 'Admin\OurCommunityBannersController@delete');
...
// Manage Host Banners Routes
    ...
    Route::group(['before' => 'manage_host_banners'], function ()
    {
        ...
        Route::match(['GET', 'POST'], 'add_host_banners', 'Admin\HostBannersController@add');

        Route::match(['GET', 'POST'], 'edit_host_banners/{id}', 'Admin\HostBannersController@update');

        Route::get('delete_host_banners/{id}', 'Admin\HostBannersController@delete');
...
Route::group(['prefix' => 'api'], function ()
{
    ...
    Route::group(['middleware' => 'jwt.auth'], function ()
    {
        ...
        Route::get('country_list', 'Api\RoomsController@country_list');
