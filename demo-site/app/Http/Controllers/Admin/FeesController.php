...
class FeesController extends Controller
{
    ...
    public function index(Request $request)
    {
        if(!$_POST)
        {
            ...
            {
                $data['penalty_currency'] = Currency::where('code',$data['result'][3]->value)->value('id');
            }
            else
            {
                $data['penalty_currency'] = Currency::where('default_currency','1')->value('id');
            }
    ...
    public function host_penalty_fees(Request $request)
    {
        ...
        {   
            $currency_code = Currency::where('id',$request->penalty_currency)->value('code');
