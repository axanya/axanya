                ...
                <div class="col-4 col-center">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <input class="btn btn-primary btn-block btn-large" name="commit" type="submit"
                                   value="{{ trans('messages.login.save_continue') }}">
                            <div class="row-space-top-2">
                                <small>
                                    {{ trans('messages.login.reset_pwd_agree') }} <a
                                            href="{{ url('terms#terms-tab-pane') }}"
                                            target="_blank">{{ trans('messages.login.terms_service') }}</a> &amp; <a
                                            href="{{ url('terms#privacy-tab-pane') }}"
                                            target="_blank">{{ trans('messages.login.privacy_policy') }}</a>.
                                </small>
                            </div>
                            {!! Form::close() !!}
                        </div>
