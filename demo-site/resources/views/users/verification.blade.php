                                ...
                                <ul class="list-layout edit-verifications-list">
                                    @if(Auth::user()->user()->users_verification->email == 'yes')
                                        <li class="edit-verifications-list-item clearfix email verified">
                                            ...
                                            <p class="description">{{ trans('messages.profile.you_have_confirmed_email') }}
                                                <b>{{ Auth::user()->user()->email }}</b>. {{ trans('messages.profile.email_verified') }}
                                            </p></li>
                                    @endif
                                                ...
                                                <div class="col-5">
                                                    <div class="disconnect-button-container">
                                                        <a href="{{ url('facebookDisconnect') }}"
                                                           class="btn gray btn-block" data-method="post"
                                                           rel="nofollow">{{ trans('messages.profile.disconnect') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-5">
                                                    <div class="connect-button">
                                                        <a href="{{ url('users/request_new_confirm_email?redirect=verification') }}"
                                                           class="btn btn-block large email-button">{{ trans('messages.profile.connect') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-5">
                                                    <div class="connect-button">
                                                        ...
                                                        <a href="{{ $fb_url }}"
                                                           class="btn btn-block large facebook-button">{{ trans('messages.profile.connect') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @if(Auth::user()->user()->users_verification->google == 'no')
                                        <li class="google unverified row-space-4 clearfix">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-5">
                                                    <div class="connect-button">
                                                        <a class="btn btn-block large"
                                                           href="{{URL::to('googleLoginVerification')}}">
                                                ...
                                                <div class="col-5">
                                                    <div class="connect-button">
                                                        <a class="btn btn-block"
                                                           href="{{URL::to('linkedinLoginVerification')}}">{{ trans('messages.profile.connect') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
