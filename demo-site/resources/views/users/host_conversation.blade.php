        ...
        <div class="page-container page-container-responsive row-space-top-4">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="alert alert-with-icon alert-success alert-block row-space-4">
                            ...
                            <p>
                                ...
                                <a class="alert-link"
                                   href="mailto:{{ $messages[0]->reservation->users->email }}">{{ trans('messages.inbox.email') }}</a>
                                <i class="icon icon-question"></i>
                            </p>

                            <div>
                                <a class="alert-link"
                                   href="{{ url() }}/reservation/itinerary?code={{ $messages[0]->reservation->code }}">{{ trans('messages.your_trips.view_itinerary') }}</a>
                                ...
                                <div class="col-sm-12 col-md-10 col-md-push-1">
                                    <div class="panel-quote-flush panel">
                                        ...
                                        <div class="panel-body normal-form-fields">
                                            ...
                                            <form id="non_special_offer_form" data-key="non_special_offer_form"
                                                  class="message_form clearfix">

                                                <input type="hidden" value="{{ $messages[0]->reservation_id }}"
                                                       name="inquiry_post_id" id="reservation_id">
                                                <input type="hidden" value="{{ $messages[0]->reservation->room_id }}"
                                                       name="room_id" id="room_id">

                                                <input type="hidden" value="" name="template">
                                                <textarea
                                                        style="resize: none; height: 62px; overflow: hidden; word-wrap: break-word;"
                                                        placeholder="{{ trans('messages.inbox.add_personal_msg') }}"
                                                        name="message" id="message_text"
                                                        class="row-space-2 input-resize-vert"></textarea>

                                                <div class="pull-right">
                                                    @if($messages[0]->reservation->type != 'contact')
                                                        <a class="btn offer_attach row-space-1"
                                                           href="javascript:void(0);">
                                                            {{ trans('messages.inbox.attach_special_offer') }}
                                                        </a>
                                                    @endif
                                                    @if($messages[0]->reservation->type == 'contact')
                                                        <a class="btn pre_approve row-space-1"
                                                           href="javascript:void(0);">
                                                            {{ trans('messages.inbox.pre_approve') }}
                                                            / {{ trans('messages.your_reservations.decline') }}
                                                        </a>
                                                    @endif

                                                    <input type="button"
                                                           value="{{ trans('messages.your_reservations.send_message') }}"
                                        ...
                                        <div class="inquiry-form-fields hide">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="h4">
                                                            ...
                                                            <br>
                                                            <small>
                                                                {{ $messages[0]->reservation->dates }}
                                                                ({{ $messages[0]->reservation->nights }} {{ trans_choice('messages.rooms.night',1) }}{{ ($messages[0]->reservation->nights > 1) ? 's' : '' }}
                                                                )
                                                                ·
                                            ...
                                            <div class="panel-body">
                                                <ul class="list-unstyled option-list">
                                                    <li data-tracking-section="accept"
                                                        class="option-list-item positive">
                                                        ...
                                                        <form class="message_form positive" id="allow_guest">
                                                            <input type="hidden"
                                                                   value="{{ $messages[0]->reservation_id }}"
                                                                   name="inquiry_post_id">

                                                            <ul class="list-unstyled action-list hide">
                                                                <!-- 1 -->
                                                                <li data-key="pre-approve"
                                                                    class="action-list-item template_1 row-space-top-1">
                                                                    <hr>
                                                                    ...
                                                                    <div class="row row-condensed">
                                                                        <div class="col-sm-offset-1 col-sm-11">
                                                                            <div class="drawer hide">
                                                                                ...
                                                                                <textarea
                                                                                        style="resize: none; height: 162px; overflow: hidden; word-wrap: break-word;"
                                                                                        class="row-space-2 input-resize-vert"
                                                                                        placeholder="{{ trans('messages.inbox.include_msg',['first_name'=>$messages[0]->reservation->users->first_name]) }}"
                                                                                        name="message"></textarea>

                                                                                <div class="pull-right">
                                                                                    <input type="submit"
                                                                                           value="{{ trans('messages.inbox.pre_approve') }}"
                                                                                           class="btn btn-primary"
                                                                                           ng-click="reply_message('pre-approve')">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <!-- 2 -->
                                                                <li data-key="special_offer"
                                                                    class="action-list-item template_2 row-space-top-1">
                                                                    <hr>
                                                                    <label class="action-label">
                                                                        <div class="row row-condensed">
                                                                            <div class="col-sm-1">
                                                                            ...
                                                                            <div class="drawer hide">
                                                                                ...
                                                                                <fieldset
                                                                                    ...
                                                                                    <div class="special-offer-date-fields">
                                                                                        <div class="row row-condensed row-space-1">
                                                                                            <div class="col-4">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       value="{{ $messages[0]->reservation->checkin_datepicker }}"
                                                                                                       name="pricing[start_date]"
                                                                                                       id="pricing_start_date"
                                                                                                       class="checkin ui-datepicker-target">
                                                                                            </div>
                                                                                            <div class="col-4">
                                                                                                <label for="pricing_end_date">{{ trans('messages.your_reservations.checkout') }}</label>
                                                                                                <input type="text"
                                                                                                       value="{{ $messages[0]->reservation->checkout_datepicker }}"
                                                                                                       name="pricing[end_date]"
                                                                                                       id="pricing_end_date"
                                                                                                       class="checkout ui-datepicker-target">
                                                                                            </div>
                                                                                            <div class="col-4">
                                                                                                <label for="pricing_guests">{{ trans_choice('messages.home.guest',2) }}</label>
                                                                                                <div class="select select-block">
                                                                                                    <select name="pricing[guests]"
                                                                                                            id="pricing_guests">
                                                                                    ...
                                                                                    <div id="availability_warning"
                                                                                         class="alert alert-with-icon alert-info  row-space-top-2 hide">
                                                                                    ...
                                                                                    <div class="row row-condensed row-space-2">
                                                                                        <div class="col-4">
                                                                                            ...
                                                                                            <div class="input-addon pricing-field">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                       value="{{ $messages[0]->reservation->subtotal }}"
                                                                                                       name="pricing[price]"
                                                                                                       id="pricing_price"
                                                                                                       class="input-stem">
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="col-4">
                                                                                            <label for="pricing_price_type">
                                                                                                &nbsp;</label>
                                                                                            <div class="select hide">
                                                                                                <select name="pricing[price_type]"
                                                                                                        id="pricing_price_type"
                                                                                                        disabled="">
                                                                                ...
                                                                                <div class="pull-right">
                                                                                    <input type="submit"
                                                                                           value="{{ trans('messages.inbox.send_offer') }}"
                                                                                           class="btn btn-primary"
                                                                                           ng-click="reply_message('special_offer')">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <li data-tracking-section="decline"
                                                        class="option-list-item negative">
                                                        <hr>
                                                        ...
                                                        <form class="message_form negative" id="decline">
                                                            ...
                                                            <ul class="list-unstyled action-list hide">
                                                                ...
                                                                <li data-key="dates_not_available"
                                                                    class="action-list-item template_NOT_AVAILABLE row-space-top-1">
                                                                    <hr>
                                                                    <label class="action-label">
                                                                        <div class="row row-condensed">
                                                                            <div class="col-sm-1">
                                                                    ...
                                                                    <div class="row row-condensed">
                                                                        <div class="col-sm-offset-1 col-sm-11">
                                                                            <div class="drawer hide">
                                                                                ...
                                                                                <textarea
                                                                                        style="resize: none; height: 82px; overflow: hidden; word-wrap: break-word;"
                                                                                        class="row-space-2 input-resize-vert"
                                                                                        placeholder="{{ trans('messages.inbox.optional_msg') }}"
                                                                                        name="message"></textarea>

                                                                                <div class="pull-right">
                                                                                    <input type="submit"
                                                                                           value="{{ trans('messages.inbox.send') }}"
                                                                                           class="btn btn-primary"
                                                                                           ng-click="reply_message('dates_not_available')">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <li data-key="not_comfortable"
                                                                    class="action-list-item template_9 row-space-top-1">
                                                                    <hr>
                                                                    <label class="action-label">
                                                                        <div class="row row-condensed">
                                                                            <div class="col-sm-1">
                                                                            ...
                                                                            <div class="drawer hide">
                                                                                ...
                                                                                <div class="pull-right">
                                                                                    <input type="submit"
                                                                                           value="{{ trans('messages.inbox.send') }}"
                                                                                           class="btn btn-primary"
                                                                                           ng-click="reply_message('not_comfortable')">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="drawer hide">
                                                                                ...
                                                                                <div class="pull-right">
                                                                                    <input type="submit"
                                                                                           value="{{ trans('messages.inbox.send') }}"
                                                                                           class="btn btn-primary"
                                                                                           ng-click="reply_message('not_a_good_fit')">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <!-- 9 -->
                                                                <li data-key="waiting_for_better_reservation"
                                                                    class="action-list-item template_9 row-space-top-1">
                                                                    <hr>
                                                                    <label class="action-label">
                                                                        <div class="row row-condensed">
                                                                ...
                                                                <!-- 9 -->
                                                                <li data-key="different_dates_than_selected"
                                                                    class="action-list-item template_9 row-space-top-1">
                                                                    <hr>
                                                                    <label class="action-label">
                                                                        <div class="row row-condensed">
                                                    ...
                                                    <li data-tracking-section="discussion"
                                                        class="option-list-item neutral">
                                                        <hr>
                                                        ...
                                                        <form class="message_form neutral" id="discussion">
                                                            ...
                                                            <ul class="list-unstyled action-list hide">
                                                                <!-- 7 -->
                                                                <li data-key="discussion"
                                                                    class="action-list-item template_7 row-space-top-1">
                                                                    <hr>
                                                                    <label class="action-label">
                                                                        <div class="row row-condensed">
                                                                            <div class="col-sm-1">
                                                                    ...
                                                                    <div class="row row-condensed">
                                                                        <div class="col-sm-offset-1 col-sm-11">
                                                                            <div class="drawer hide">
                                                                                ...
                                                                                <textarea
                                                                                        style="resize: none; height: 122px; overflow: hidden; word-wrap: break-word;"
                                                                                        class="row-space-2 input-resize-vert required"
                                                                                        placeholder="{{ trans('messages.inbox.only_guest_see_msg') }}"
                                                                                        name="message"></textarea>
                                                                                ...
                                                                                <div class="pull-right">
                                                                                    <input type="submit"
                                                                                           value="{{ trans('messages.inbox.send') }}"
                                                                                           class="btn btn-primary"
                                                                                           ng-click="reply_message('discussion')">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
          ...
          {{ trans('messages.inbox.special_offer') }}
                                                            ...
                                                            <div class="h5">
                                                                ...
                                                                <a href="{{ url('rooms/'.$messages[$i]->special_offer->room_id) }}">{{ $messages[$i]->special_offer->rooms->name }}</a>
                                                            </div>
                                                            <p class="text-muted">
                                                                ...
                                                                <br>
                                                                <strong>{{ trans('messages.inbox.you_could_earn') }} {{ $messages[$i]->special_offer->currency->symbol.$messages[$i]->special_offer->price }} {{ $messages[$i]->special_offer->currency->session_code }}</strong>
                                                        ...
                                                        <div class="panel-body">
                                                            <a href="{{ url() }}/messaging/remove_special_offer/{{ $messages[$i]->special_offer_id }}"
                                                               class="btn" data-confirm="Are you sure?"
                                                               data-method="post"
                                                               rel="nofollow">{{ trans('messages.inbox.remove_special_offer') }}</a>
                                                ...
                                                <div class="col-md-10 col-md-offset-1">
                                                    <div class="panel row-space-4">
                                                        <div class="panel-body panel-dark">
                                                            <div class="h5">
                                                                {{ $messages[$i]->reservation->users->first_name }} {{ trans('messages.inbox.pre_approved_stay_at') }}
                                                                <a href="{{ url('rooms/'.$messages[$i]->reservation->room_id) }}">{{ $messages[$i]->special_offer->rooms->name }}</a>
                                                            </div>
                                                            <p class="text-muted">
                                                                {{ $messages[$i]->special_offer->dates }}
                                                                ·
                                                        ...
                                                        <div class="panel-body">
                                                            <a href="{{ url() }}/messaging/remove_special_offer/{{ $messages[$i]->special_offer_id }}"
                                                               class="btn" data-confirm="Are you sure?"
                                                               data-method="post"
                                                               rel="nofollow">{{ trans('messages.inbox.remove_pre_approval') }}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row row-condensed">
                                            <div class="col-sm-2 col-md-1 text-center">
                                                <a aria-label="{{ $messages[$i]->reservation->rooms->users->first_name }}"
                                                   data-behavior="tooltip" class="media-photo media-round"
                                                   href="{{ url() }}/users/show/{{ $messages[$i]->reservation->host_id }}"><span
                                                            title="{{ $messages[$i]->reservation->rooms->users->first_name }}"
                                                            style="background-image:url({{ $messages[$i]->reservation->rooms->users->profile_picture->src }}); width:36px; height:36px;"></span></a>
                                            </div>
                                    ...
                                    <li id="question2_post_{{ $messages[$i]->id }}" class="thread-list-item">
                                            ...
                                            <div class="row row-condensed">
                                                <div class="col-md-10 col-md-offset-1">
                                                    <div class="panel row-space-4">
                                                        <div class="panel-body panel-dark">
                                                            <div class="h5">
                                                                {{ trans('messages.inbox.inquiry_about') }} <a
                                                                        locale="en" data-popup="true"
                                                                        href="{{ url() }}/rooms/{{ $messages[$i]->reservation->room_id }}">{{ $messages[$i]->reservation->rooms->name }}</a>
                                                            </div>
                                                            <p class="text-muted">
                                        ...
                                        <div class="row row-condensed">
                                            ...
                                            <div class="col-sm-2 col-md-1 col-md-push-1 text-center">
                                                <a aria-label="{{ $messages[$i]->reservation->users->first_name }}"
                                                   data-behavior="tooltip" class="media-photo media-round"
                                                   href="{{ url() }}/users/show/{{ $messages[$i]->reservation->user_id }}"><span
                                                            title="{{ $messages[$i]->reservation->users->first_name }}"
                                                            style="background-image:url({{ $messages[$i]->reservation->users->profile_picture->src }}); width:36px; height:36px;"></span></a>
                                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="panel row-space-4">
                        ...
                        <div class="mini-profile va-container media">
                            <div class="va-top pull-left">
                                <a class="media-photo"
                                   href="{{ url() }}/users/show/{{ $messages[0]->reservation->user_id }}">
                            ...
                            <div class="va-middle">
                                <div class="h4">
                                    <a class="text-normal"
                                       href="{{ url() }}/users/show/{{ $messages[0]->reservation->user_id }}">{{ $messages[0]->reservation->users->first_name }}</a>
                                    &nbsp;
                    ...
                    <a href="{{ url() }}/manage-listing/{{ $messages[0]->reservation->room_id }}/calendar"
                       id="edit_calendar_url">
