                            ...
                            <div class="panel-body">
                                ...
                                <div class="row row-condensed space-4">
                                    <label class="text-right col-sm-3" for="user_gender">
                                        {{ trans('messages.profile.i_am') }} <i class="icon icon-lock icon-ebisu"
                                ...
                                <div class="row row-condensed space-4">
                                    <label class="text-right col-sm-3" for="user_birthdate">
                                        {{ trans('messages.profile.birth_date') }} <i class="icon icon-lock icon-ebisu"
                                                                                      data-behavior="tooltip"
                                                                                      aria-label="Private"></i>
                                    </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row row-condensed space-4">
                                    <label class="text-right col-sm-3" for="user_email">
                                        {{ trans('messages.dashboard.email_address') }} <i
                                ...
                                <div class="row row-condensed space-4">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="text-muted row-space-top-1">{{ trans('messages.profile.about_desc1', ['site_name'=>$site_name]) }}
                                            <br><br>{{ trans('messages.profile.about_desc2') }}
                                            <br><br>{{ trans('messages.profile.about_desc3', ['site_name'=>$site_name]) }}
                                            <br><br>{{ trans('messages.profile.about_desc4') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
