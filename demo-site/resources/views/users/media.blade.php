    ...
    <main id="site-content" role="main">
        ...
        <div class="page-container-responsive space-top-4 space-4">
                            ...
                            <div class="panel-body photos-section">
                                <div class="row">
                                    <div class="col-lg-4 text-center">
                                        <div data-picture-id="91711885"
                                             class="profile_pic_container picture-main space-sm-2 space-md-2">
                                            <div class="media-photo profile-pic-background prof_pic1">
                                                <img width="225" height="225" src="">
                                            </div>
                                            <div class="media-photo media-round prof_pic1"
                                                 style="background:url({{ $result->profile_picture->src }})">
                                                <img width="225" height="225" src="">
                                            </div>
                                        </div>
                                    </div>
            ...
            <span class="btn btn-block btn-large file-input-container">
                ...
                <form name="ajax_upload_form" method="post" id="ajax_upload_form" enctype="multipart/form-data"
                      action="{{ url() }}/users/image_upload" accept-charset="UTF-8">
                {!! Form::token() !!}
