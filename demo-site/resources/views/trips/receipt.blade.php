                ...
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <div class="pull-right hide-print">
                            <a id="print_receipt" onclick="print_receipt()" class="btn"
                               href="#">{{ trans('messages.your_trips.receipt') }}</a>
                        </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row row-space-condensed">
                            <div class="col-3">
                                ...
                                <p class="text-lead">{{ $reservation_details->rooms->rooms_address->address_line_1 }}
                                    ...
                                    <br>{{ $reservation_details->rooms->rooms_address->country_name }}<br></p>
                            </div>
                            <div class="col-3">
                                <h6>
                            ...
                            <div class="col-3">
                                ...
                                <p class="text-lead">
                                    ...
                                    <br>{{ trans('messages.your_reservations.flexible_checkin_time') }}
                                </p>
                            </div>
                            <div class="col-3">
                                <h6>
                                ...
                                <p class="text-lead">
                                    ...
                                    <br>{{ trans('messages.your_reservations.flexible_checkout_time') }}
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-bordered payment-table">
                                    ...
                                    @if($reservation_details->coupon_amount)
                                        <tr>
                                            ...
                                            <td class="receipt-amount">
                                                -{{ $reservation_details->currency->symbol.$reservation_details->coupon_amount }}</td>
                                        </tr>
                                    @endif
                                    <tr>
                                        <th class="receipt-label">
