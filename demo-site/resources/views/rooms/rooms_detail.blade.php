...
@section('main')
    ...
    <main id="site-content" role="main" ng-controller="rooms_detail">
        ...
        <div class="subnav-container">
            ...
            <div data-sticky="true" data-transition-at="#summary" aria-hidden="true"
                 class="subnav section-titles hide-md">
    ...
    <span class="cover-img-container img-box1" data-hook="cover-img-container">
     <a href="{{ url('rooms/'.$result->id.'/slider') }}" oncontextmenu="return false" class="gallery"
      ...
      <div id="frontimage_slider" class="cover-img" data-hook="img-lg" style="background-image:
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 space-sm-4 text-center space-sm-2">
                                        ...
                                        <div class="media-photo-badge">
                                            ...
                                            <a href="{{ url('users/show/'.$result->user_id) }}"
                                               class="media-photo media-round prof_pic">

                                                <span class="host-profile-image" data-pin-nopin="true"
                                                      style="width:115px; height:115px; background-image:url({{ $result->users->profile_picture->src }})"
                                                      title="{{ $result->users->first_name }}"></span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div id="display-address" class="row-space-2 text-muted text-center-sm"
                                            ...
                                            <a href=""
                                               class="link-reset">{{$result->rooms_address->city}} @if($result->rooms_address->city !='')
                                                    ,@endif {{$result->rooms_address->state}} @if($result->rooms_address->state !='')
                                                    ,@endif {{$result->rooms_address->country_name}}</a>
                                            &nbsp;
        ...
        <span>)</span>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div id="tax-descriptions-tip" class="tooltip tooltip-top-middle" role="tooltip"
                                 data-sticky="true" data-trigger="#tax-descriptions-tooltip">
                            </div>
                            <form accept-charset="UTF-8" action="{{ url('payments/book/'.$room_id) }}" id="book_it_form"
                                  method="post">
                                {!! Form::token() !!}
                                ...
                                <div id="pricing" itemprop="offers" itemscope="" class="">
                                    <div id="price_amount"
                                         class="book-it-price-amount pull-left h3 text-special">{{ $result->rooms_price->currency->symbol }}
                                        <span id="rooms_price_amount" value="">{{ $result->rooms_price->night }}</span>
                                        @if($result->booking_type == 'instant_book')
                                            <span aria-label="Book Instantly" data-behavior="tooltip"
                                                  class="h3 icon-beach">
      <i class="icon icon-instant-book icon-flush-sides"></i>
                                    ...
                                    <div id="payment-period-container" class="pull-right">
                                        ...
                                        <div id="per_month" class="per-month hide">
                                            ...
                                            <i id="price-info-tooltip" class="icon icon-question hide"
                                        ...
                                        <div class="panel-body panel-light">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="row row-condensed">
                                                            <div class="col-sm-6 space-1-sm">
                                                                ...
                                                                <input class="checkin ui-datepicker-target"
                                                                       id="list_checkin" name="checkin"
                                                                       placeholder="{{ trans('messages.rooms.dd-mm-yyyy') }}"
                                                                       type="text">
                                                            </div>

                                                            <input type="hidden" ng-model="room_id"
                                                                   ng-init="room_id = {{ $room_id }}">
                                                            ...
                                                            <input type="hidden" id="url_checkin"
                                                                   value="{{ $checkin }}">
                                                            <input type="hidden" id="url_checkout"
                                                                   value="{{ $checkout }}">
                                                            ...
                                                            <div class="col-sm-6 space-1-sm">
                                                                ...
                                                                <input class="checkout ui-datepicker-target"
                                                                       id="list_checkout" name="checkout"
                                                                       placeholder="{{ trans('messages.rooms.dd-mm-yyyy') }}"
                                                                       type="text">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="js-book-it-status">
                                                <div class="js-book-it-enabled clearfix">
                                                        ...
                                                        <table class="table table-bordered price_table">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    {{ $result->rooms_price->currency->symbol }} <span
                                                                            ...
                                                                            value="">{{ $result->rooms_price->night }}</span>
                                                                    x <span id="total_night_count"
                                                                            value="">0</span> {{ trans_choice('messages.rooms.night',1) }}

                                                                </td>
                                                                <td>{{ $result->rooms_price->currency->symbol }}<span
                                                                            id="total_night_price" value="">0</span>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <i id="service-fee-tooltip"
                                                                       class="icon icon-question"></i>

                                                                </td>
                                                                <td>{{ $result->rooms_price->currency->symbol }}<span
                                                                            id="service_fee" value="">0</span></td>
                                                            </tr>
                                                            ...
                                                            <tr class="additional_price">
                                                                ...
                                                                <td>{{ $result->rooms_price->currency->symbol }}<span
                                                                            id="additional_guest" value="">0</span></td>
                                                            </tr>
                                                            ...
                                                            <tr class="security_price">
                                                                ...
                                                                <td>{{ $result->rooms_price->currency->symbol }}<span
                                                                            id="security_fee" value="">0</span></td>
                                                            </tr>
                                                            ...
                                                            <tr class="cleaning_price">
                                                                ...
                                                                <td>{{ $result->rooms_price->currency->symbol }}<span
                                                                            id="cleaning_fee" value="">0</span></td>
                                                            </tr>

                                                            <tr>
                                                                <td>{{ trans('messages.rooms.total') }}</td>
                                                                <td>{{ $result->rooms_price->currency->symbol }}<span
                                                                            id="total" value="">0</span></td>
                                                            </tr>
                                                    ...
                                                    <div id="book_it_disabled" class="text-center"
                                                         style="display:none;">
                                                        <p id="book_it_disabled_message" class="icon-rausch">
                                                            {{ trans('messages.rooms.dates_not_available') }}
                                                        </p>
                                                        <a href="{{URL::to('/')}}/s?location={{$result->rooms_address->city }}"
                                                    ...
                                                    <div class="js-book-it-btn-container {{ ($result->user_id == @Auth::user()->user()->id) ? 'hide' : '' }}">
                                                        <button type="submit"
                                                                class="js-book-it-btn btn btn-large btn-block btn-primary">
                                        ...
                                        <div class="panel-body panel-light">
                                            @if(Auth::user()->check())
                                                <div class="wishlist-wrapper hide-sm">
                                                    <div class="rich-toggle wish_list_button not_saved"
                                                         data-hosting_id="{{ $result->id }}">
                                                        <input type="checkbox" name="wishlist-button"
                                                               id="wishlist-button">
  ...
  <span class="share-title">
    {{ trans('messages.rooms.share') }}:
      ...
      <a class="share-btn link-icon" data-email-share-link="" data-network="email" rel="nofollow"
         title="{{ trans('messages.login.email') }}"
         href="mailto:?subject=I love this room&amp;body=Check out this {{ Request::url() }}">
        <span class="screen-reader-only">{{ trans('messages.login.email') }}</span>
        <i class="icon icon-envelope social-icon-size"></i>
      </a>
      <a class="share-btn link-icon" data-network="facebook" rel="nofollow" title="Facebook"
         href="http://www.facebook.com/sharer.php?u={{ Request::url() }}" target="_blank">
        <span class="screen-reader-only">Facebook</span>
        <i class="icon icon-facebook social-icon-size"></i>
      </a>

      <a class="share-btn link-icon" data-network="twitter" rel="nofollow" title="Twitter"
         href="http://twitter.com/home?status=Love this! {{ $result->name }} - {{ $result->property_type_name }} for Rent - {{ "@".$site_name}} Travel  {{ Request::url() }}"
         target="_blank">
        <span class="screen-reader-only">Twitter</span>
        <i class="icon icon-twitter social-icon-size"></i>
      </a>  
       
    <a class="share-btn link-icon" data-network="pinterest" rel="nofollow" title="Pinterest"
       href="http://pinterest.com/pin/create/button/?url={{ Request::url() }}&media={{ url('images/'.$result->photo_name) }}&description={{ $result->summary }}"
       target="_blank">
      ...
      <a class="share-btn link-icon" href="https://plus.google.com/share?url={{ Request::url() }}" itemprop="nofollow"
                    ...
                    <div class="col-lg-8" id="details-column">
                            ...
                            <div class="space-4 space-top-4 show-sm">
                                @foreach($rooms_photos as $row_photos)
                                    <div class="inline-photo panel-image">
                                        <a href="{{ url('images/rooms/'.$room_id.'/'.$row_photos->name) }}"
                                           class="photo-trigger" data-index="1">
                                            <img src="{{ url('images/rooms/'.$room_id.'/'.$row_photos->name) }}"
                                                 alt="{{ $row_photos->highlights }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            @if($result->bed_type_name != NULL)
                                                <div>{{ trans('messages.rooms.bed_type') }}:
                                                    <strong>{{ $result->bed_type_name }}</strong></div>
                                            @endif
                                            <div>{{ trans('messages.rooms.property_type') }}: <strong><a href="#"
                                                                                                         class="link-reset">{{ $result->property_type_name }}</a></strong>
                                            </div>

                                            <div>{{ trans('messages.lys.accommodates') }}:
                                                <strong>{{ $result->accommodates }}</strong></div>
                                        </div>
                                        <div class="col-md-6">

                                            <div>{{ trans('messages.lys.bedrooms') }}:
                                                <strong>{{ $result->bedrooms }}</strong></div>

                                            <div>{{ trans('messages.lys.bathrooms') }}:
                                                <strong>{{ $result->bathrooms }}</strong></div>

                                            <div>{{ trans('messages.lys.beds') }}: <strong>{{ $result->beds }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @endif
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                {{--*/ $i++ /*--}}
                                                                @endforeach
                                                                <a class="expandable-trigger-more amenities_trigger"
                                                                   href="">
                                                ...
                                                <div class="col-md-6">
                                                    <div>{{ trans('messages.rooms.extra_people') }}: <strong>
                                                            @if($result->rooms_price->guests !=0)
                                                                ...
                                                                <span> {{ $result->rooms_price->currency->symbol }} {{ $result->rooms_price->additional_guest }}
                                                                    / {{ trans('messages.rooms.night_after_guest',['count'=>$result->rooms_price->guests]) }}</span>
                                                    ...
                                                    <div>{{ trans('messages.lys.weekly_price') }}:
                                                        @if($result->rooms_price->week != 0)
                                                            <strong> <span
                                                                        id="weekly_price_string">{{ $result->rooms_price->currency->symbol }} {{ $result->rooms_price->week }}</span>
                                                                /{{ trans('messages.rooms.week') }}</strong>
                                                        @else
                                                            <strong><span
                                                                        id="weekly_price_string">{{ $result->rooms_price->currency->symbol }} {{ number_format($result->rooms_price->night * 7) }}</span>
                                                                /{{ trans('messages.rooms.week') }}</strong>
                                                ...
                                                <div class="col-md-6">
                                                    <div>{{ trans('messages.lys.monthly_price') }}:
                                                        @if($result->rooms_price->month != 0)
                                                            <strong> <span
                                                                        id="weekly_price_string">{{ $result->rooms_price->currency->symbol }} {{ $result->rooms_price->month }}</span>
                                                                /{{ trans('messages.rooms.month') }}</strong>
                                                        @else
                                                            <strong><span
                                                                        id="weekly_price_string">{{ $result->rooms_price->currency->symbol }} {{ number_format($result->rooms_price->night * 30) }}</span>
                                                                /{{ trans('messages.rooms.month') }}</strong>
                                                                        ...
                                                                        @foreach($religious_amenities_type_array as $k => $religious_amenity_type)
                                                                            <div class="space-2">
                                                                                ...
                                                                                @foreach($religious_amenity_type as $religious_amenity)
                                                                                    <div class="row-space-1 @if($religious_amenity->status == null)text-muted @endif "
                                                                                         style="margin-left:10px;">
                      <span class="js-present-safety-feature"><strong>
                        @if($religious_amenity->status == null)
                                  <del>
                        @endif
                                      {{ $religious_amenity->name }} @if($religious_amenity->description != '')
                                          ( {{ $religious_amenity->description }}
                                          )@endif @if(@$religious_amenities_extra_data[$religious_amenity->id])
                                          - {{$religious_amenities_extra_data[$religious_amenity->id]}} @endif
                                      @if($religious_amenity->status == null)
                            </del>
                              @endif
                      </strong></span>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <a id="view-calendar"
                                                           href="#"><strong>{{ trans('messages.rooms.view_calendar') }}</strong></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row featured-height">
                                                        <div class="col-12 row-full-height img-box1">
                                                            <a class="photo-grid-photo photo-trigger gallery"
                                                               ...
                                                               data-index="1" data-lightbox-type="iframe">
                                                                <img src="{{ 'images/rooms/'.$room_id.'/'.$row_photos->name }}"
                                                                     class="hide" alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                @if($i==3 && $i >2)
                                                    <div class="col-6 supporting-height img-box1">
                                                        <a class="photo-grid-photo photo-trigger gallery"
                                                           style="background-image: url({{ url('images/rooms/'.$room_id.'/'.$row_photos->name) }})"
                                                           href="{{ url('rooms/'.$result->id.'/slider') }}"
                                                           data-index="2" data-lightbox-type="iframe">
                                                            <img src="{{ 'images/rooms/'.$room_id.'/'.$row_photos->name }}"
                                                                 class="hide" alt="">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="review-content">
                                                <div class="panel-body">
                                                    ...
                                                    @if($result->users->reviews->count())
                                                        ...
                                                        <a href="{{ url('users/show/'.$result->user_id) }}"
                                                           class="btn">{{ trans('messages.rooms.view_other_reviews') }}</a>
                                                    @endif
                                                </div>
                                            </div>
                                        @else
                                                                        ...
                                                                        <div class="col-md-3 text-center space-2">
                                                                            <div class="media-photo-badge">
                                                                                <a class="media-photo media-round"
                                                                                   href="{{ url('users/show/'.$row_review->user_from) }}">
                                                                                    <span title="{{ $row_review->users_from->first_name }}"
                                                                                          style="width:67px; height:67px; background-image:url({{ $row_review->users_from->profile_picture->src }})"
                                                                                          data-pin-nopin="true"></span>
                                                                                </a>
                                                                            </div>
                                                                            <div class="name">
                                                                                <a target="_blank"
                                                                                   class="text-muted link-reset"
                                                                                   href="{{ url('users/show/'.$row_review->user_from) }}">{{ $row_review->users_from->first_name }}</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-9">
                                                                            <div class="space-2">
                                                                                <div class="review-text"
                                                                                     data-review-id="{{ $row_review->id }}">
                                                                                ...
                                                                                <div class="text-muted review-subtext">
                                                                                    ...
                                                                                    <div class="va-container va-container-h va-container-v">
                                                                                        <div class="va-middle">
                                                                                            <span class="date"
                                                                                                  style="display:inline-block;">{{ $row_review->date_fy }}</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            @if($result->users->reviews->count() - $result->reviews->count())
                                                                <div class="row row-space-top-2">
                                                                    <div class="col-lg-9 col-offset-3">
                                                                        ...
                                                                        <a target="blank" class="btn"
                                                                           href="{{ url('users/show/'.$result->user_id) }}">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 text-center">
                                            <a href="{{ url('users/show/'.$result->user_id) }}"
                                               class="media-photo media-round prof_pic"><span data-pin-nopin="true"
                                                                                              style="width:90px; height:90px; background-image:url({{ $result->users->profile_picture->src }});"
                                            ...
                                            @if(Auth::user()->check())
                                                @if(Auth::user()->user()->id != $result->user_id)
                                                    <div id="contact_wrapper">
                                                        <button id="host-profile-contact-btn"
                                            ...
                                            <div class="row row-condensed">
                                                <div class="col-sm-4 col-md-3">
                                                    <a class="link-reset" rel="nofollow"
                                                       href="{{ url('users/show/'.$result->user_id) }}#reviews">
                    ...
                    <div id="neighborhood" class="room-section">
                        <div class="page-container-responsive" data-reactid=".2" style="position:relative;">
                            <div class="panel location-panel">
                                <div id="map" data-lat="{{ $result->rooms_address->latitude }}"
                                     data-lng="{{ $result->rooms_address->longitude }}"
                                     data-address="{{ $result->rooms_address->state }}+{{ $result->rooms_address->country }}"></div>
                                <ul id="guidebook-recommendations" class="hide">
                                    <li class="user-image">
                                        <a href=""><img alt="Jeya" data-pin-nopin="true" height="90" src="" title="Jeya"
                                                        width="90"></a>
                                    </li>
                                </ul>
                                        ...
                                        <div class="col-md-4">
                                            <div class="listing">
                                                <div class="panel-image listing-img">
                                                    <a href="{{ url('rooms/'.$row_similar->id) }}" target="_self"
                                                       class="media-photo media-cover" target="_blank">
                                                       ...
                                                       target="_blank">
                                                        <div>
                                                            ...
                                                            @if($row_similar->koshire =='1')
                                                                <span data-original-title="This house is Kosher"
                                                                      data-toggle="tooltip" class="h3 icon-k">K</span>
                                                            @endif
                                                            @if($row_similar->booking_type == 'instant_book')
                                                                <span aria-label="Book Instantly"
                                                                      data-behavior="tooltip" class="h3 icon-beach">
      <i class="icon icon-instant-book icon-flush-sides"></i>
    </span>
                                                            @endif
                                                        </div>
                                                ...
                                                <div class="panel-body panel-card-section">
                                                    <div class="media">
                                                        ...
                                                        <a href="{{ url('rooms/'.$row_similar->id) }}" target="_self"
                                                           class="text-normal">
                                                            <h3 title="{{ $row_similar->name }} " itemprop="name"
                                                                class="h5 listing-name text-truncate row-space-top-1">
                                                                {{ $row_similar->name }}
                                                            </h3>
                                                        </a>
                                                        <div itemprop="description"
                                                             class="text-muted listing-location text-truncate">{{ $row_similar->room_type_name }}
                                                            — {{ number_format($row_similar->distance,2) }} {{ trans('messages.rooms.km_away') }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<span data-pin-nopin="true"
      style="width:120px; height:120px; background-image:url({{ $result->users->profile_picture->src }})"
      title="{{ $result->users->first_name }}"></span>
</a>
</div>
</div>
...
<div class="panel-body">
<form id="message_form" class="contact-host-panel" action="{{ url() }}/users/ask_question/{{ $result->id }}"
      method="POST">
{!! Form::token() !!}
    <h5>
...
<input value="" name="message_checkin" id="message_checkin" class="checkin text-center ui-datepicker-target"
       placeholder="{{ trans('messages.home.checkin') }}" type="text" required>
</div>
<div class="col-4 input-col">
<label class="screen-reader-only">{{ trans('messages.home.checkout') }}</label>
<input value="" name="message_checkout" id="message_checkout" class="checkout text-center ui-datepicker-target"
       placeholder="{{ trans('messages.home.checkout') }}" type="text" required>
</div>
</div>
<div class="col-4 input-col">
<div class="select select-block">
...
<div class="panel-body">
<textarea class="focus-on-active" name="question"
          placeholder="{{ trans('messages.rooms.start_your_msg') }}..."></textarea>
</div>
</div>
</div>
</div>
...
<div class="media-photo media-round">
<div class="media-photo-badge">
<a href="{{ url() }}/users/show/{{ (Auth::user()->check()) ? Auth::user()->user()->id : '' }}"
   class="media-photo media-round">
<span data-pin-nopin="true"
      style="width:68px; height:68px; background-image:url({{ (Auth::user()->check()) ? Auth::user()->user()->profile_picture->src : '' }})"
      title="{{ (Auth::user()->check()) ? Auth::user()->user()->first_name : '' }}"></span>
</a>
</div>
</div>
</div>
                            ...
                            <div class="row row-margin-zero">
                                <div class="hide-sm hide-md col-lg-7 wl-modal__col">
                                    <div class="media-cover media-cover-dark background-cover background-listing-img"
                                         style="background-image:url({{ url('images/'.$result->photo_name) }});">
                                    </div>
                                    <div class="panel-overlay-top-left text-contrast wl-modal-listing-tabbed">
                                        <div class="va-container media">
                                            <span class="pull-left host-profile-img media-photo media-round space-2"
                                                  style="width:67px; height:67px; background-image:url({{ $result->users->profile_picture->src }})"></span>
                                                ...
                                                <strong>
                                                    <div class="pull-left text-lead va-container va-container-v">
                                                        <input type="text"
                                                               ...
                                                               value="{{ $result->rooms_address->city }}"
