...
@section('main')
    <main id="site-content" role="main">
        ...
        <span class="h4">
        <a href="{{ url('rooms/'.$row->id) }}"
           class="text-normal">{{ ($row->name == '') ? $row->sub_name : $row->name }}</a>
        </span>
                                                            ...
                                                            <div class="listing-criteria-header activation-notification hide-lg space-top-2">
                                                                <div class="listing-criteria-header-message">
                                                                    @if($row->steps_count != 0)
                                                                        <a class="btn btn-host"
                                                                           href="{{ url('manage-listing/'.$row->id.'/basics') }}">{{ $row->steps_count }} {{ trans('messages.your_listing.steps_to_list') }}</a>
                                                                    @else
                                                            ...
                                                            <div class="listing-criteria-header activation-notification hide-lg space-top-2">
                                                                <div class="listing-criteria-header-message">
                                                                    @if($row->steps_count == 0 && $row->status == NULL)
                                                                        <a class="btn btn-host"
                                                                           href="{{ url('manage-listing/'.$row->id.'/basics') }}">{{ trans('messages.your_listing.pending') }}</a>
