<div id="header"
     class="axanya-header new {{ (!isset($exception)) ? (Route::current()->uri() == '/' ? 'shift-with-hiw' : '') : '' }}">
        ...
        <div class="title--sm text-center">
            ...
            <span class="screen-reader-only">
              {{ $site_name }}
                ...
                <a href="javascript:void(0);" aria-label="Homepage" data-prevent-default=""
			  ...
			  {{ $site_name }}
                ...
                <div class="title--sm text-center mob_search">
                    <button class="btn btn-block search-btn--sm search-modal-trigger "
                        ...
                        <div id="icon-drawer-search-icon" data-reactid=".0.0.3">
                            <svg viewBox="0 0 24 24" style="fill:currentColor;height:1em;width:1em;display:block;"
                                 data-reactid=".0.0.3.0">
                    ...
                    <div class="nav-menu panel-body">
                        <ul class="menu-group list-unstyled">
                            ...
                            <li class="{{ (Auth::user()->user()) ? '' : 'items-logged-in' }}">
                                <a href="{{ url() }}/users/show/{{ (Auth::user()->user()) ? Auth::user()->user()->id : '0' }}"
                            ...
                            <li class="items-logged-in">
                                <a href="{{ url() }}/dashboard" class="link-reset menu-item dashboard hide"
                                   rel="nofollow">
                            ...
                            <li>
                                <a href="{{ url() }}/rooms/new" class="link-reset menu-item become-a-host"
                                   rel="nofollow">
                                    {{ trans('messages.header.list_your_space') }}
                                </a>
                            </li>
                            <li class="{{ (Auth::user()->user()) ? 'items-logged-out' : '' }}">
                                <a data-signup-modal="" href="{{ url() }}/signup_login" class="link-reset menu-item"
                                   rel="nofollow">
                            ...
                            <li><a href="{{ url('contact') }}"
                                   class="link-reset menu-item">{{ trans('messages.footer.contact') }}</a></li>
                            <li class="{{ (Auth::user()->user()) ? '' : 'items-logged-in' }}">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="panel-body">
                                <div class="modal-search-wrapper--sm">
                                    ...
                                    <div class="row">
                                        <div class="searchbar__location-error hide"
                                             style="left:22px; top:2%;">{{ trans('messages.home.search_validation') }}</div>
                                        <div class="col-sm-12">
                                            <label for="header-location--sm">
                                                ...
                                                <input type="text"
                                                       ...
                                                       autocomplete="off" name="location" id="header-location--sm"
                                    ...
                                    <div class="row row-condensed">
                                        <div class="col-sm-6">
                                            <label class="checkin">
                                                ...
                                                <input type="text" name="checkin" id="modal_checkin"
                                        ...
                                        <div class="col-sm-6">
                                            <label class="checkout">
                                                ...
                                                <input type="text" name="checkout" id="modal_checkout"
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="select select-block select-large">
                                                <select id="modal_guests" name="guests--sm">
                                                    @for($i=1;$i<=16;$i++)
                                                        <option value="{{ $i }}" {{ ($i == @$guest) ? 'selected' : '' }}>{{ $i }}
                                                            guest{{ ($i>1) ? 's' : '' }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="row text-center">
                                                @foreach($header_room_type as $row)
                                                    ...
                                                    <label class="col-sm-4 modal-filter needsclick"
                                                           for="room-type-{{ $row->id }}--sm">
                                                        <input type="checkbox" id="room-type-{{ $row->id }}--sm"
                                                               name="room_types[]"
                                                               value="{{ $row->id }}" {{ (@in_array($row->id,@$room_type_selected)) ? 'checked' : '' }}>
                                                        @if($row->id == 1)
    ...
    <header class="regular-header clearfix hide-sm" id="old-header" role="banner">
        <a aria-label="Homepage" href="{{ url() }}"
           class="header-belo pull-left {{ (!isset($exception)) ? (Route::current()->uri() == '/' ? 'home-logo' : '') : '' }}"
           style="{{ (!isset($exception)) ? (Route::current()->uri() == '/' ? $home_logo_style : $logo_style) : $logo_style }}">
    <span class="screen-reader-only">
      {{ $site_name }}
    </span>
        </a>
        ...
        @if(Request::segment(1) != 'help')
            <ul class="nav pull-left  list-unstyled search-form-container" id="search-form-header">
                    ...
                    <form action="{{ url() }}/s" class="search-form">
                        <div class="search-bar">
                            ...
                            <label class="screen-reader-only"
                                   for="header-search-form">{{ trans('messages.header.where_are_you_going') }}</label>
                            <input type="text" placeholder="{{ trans('messages.header.where_are_you_going') }}"
                                   autocomplete="off" name="location" id="header-search-form" class="location" value="">
                        </div>
                        <div id="header-search-settings" class="panel search-settings header-menu">
                            <div class="panel-body clearfix basic-settings">
                                <div class="setting checkin">
                                    ...
                                    <input type="text" id="header-search-checkin" data-field-name="check_in_dates"
                                           name="checkin" class="checkin ui-datepicker-target"
                                           placeholder="{{ trans('messages.rooms.dd-mm-yyyy') }}"></div>

                                <div class="setting checkout">
                                    <label for="header-search-checkout" class="field-label">
                                        <strong>{{ trans('messages.home.checkout') }}</strong>
                                    </label>
                                    <input type="text" id="header-search-checkout" data-field-name="check_out_dates"
                                           class="checkout ui-datepicker-target" name="checkout"
                                           placeholder="{{ trans('messages.rooms.dd-mm-yyyy') }}"></div>
                                ...
                                <div class="setting guests">
                                    ...
                                    <div class="select select-block">
                                        <select id="header-search-guests" data-field-name="number_of_guests"
                                                name="guests">
                                            @for($i=1;$i<=16;$i++)
                                ...
                                <div class="row-space-4">
                                    @foreach($header_room_type as $row)
                                        <label class="checkbox menu-item" for="header_room_type_{{ $row->id }}">
                                            <input type="checkbox" id="header_room_type_{{ $row->id }}"
                                                   name="room_types[]" value="{{ $row->id }}">
                                            @if($row->id == 1)
                ...
                <li class="dropdown-trigger pull-left large-right-margin hide-sm hide"
                    data-behavior="recently-viewed__container">
                    <a class="no-crawl link-reset" href="{{ url() }}/login?_ga=1.237472128.1006317855.1436675116#"
                       data-href="/history#docked-filters" data-behavior="recently-viewed__trigger">
      <span class="show-lg recently-viewed__label">
        ...
        <i class="icon icon-recently-viewed icon-gray h4"></i>
                    ...
                    <div class="tooltip tooltip-top-left dropdown-menu recently-viewed__dropdown"
      ...
      <span class="value_name">
        {{ Auth::user()->user()->first_name }}
                        ...
                        <div class="media-photo media-round user-profile-image"
                             style="background: rgba(0, 0, 0, 0) url({{ Auth::user()->user()->profile_picture->header_src }}) no-repeat scroll 0 0 / cover"></div>
                    </a>
                    <ul class="tooltip tooltip-top-right dropdown-menu list-unstyled header-dropdown">
                        ...
                        <li class="edit-password">
                            <a href="{{ url('users/security') }}" rel="nofollow"
                               class="no-crawl link-reset menu-item item-edit-password">
        ...
        <ul class="nav pull-right help-menu list-unstyled">
            <li id="header-help-menu"
                class="help-menu-container pull-right large-right-margin hide-md dropdown-trigger header_item">
        ...
        @if(Auth::user()->check())
            <ul class="nav pull-right list-unstyled medium-right-margin">
                <li id="inbox-item" class="inbox-item pull-left dropdown-trigger js-inbox-comp header_item">
                    <a href="{{ url('inbox') }}" rel="nofollow"
                       class="no-crawl link-reset">{{ trans('messages.header.messages') }}
          ...
          {{ trans('messages.header.inbox') }}
                    ...
                    <div class="tooltip tooltip-top-right dropdown-menu list-unstyled header-dropdown notifications-dropdown">
                        <div class="notifications-tooltip panel" data-reactid=".1">
                            <div class="panel-header no-border" data-reactid=".1.0"><strong data-reactid=".1.0.0"><span
                                            data-reactid=".1.0.0.0">
      <a href="{{ url('inbox') }}" rel="nofollow"
         class="no-crawl link-reset">{{ trans('messages.header.messages') }}</a>
      </span><span data-reactid=".1.0.0.1"> (</span><span
                                            data-reactid=".1.0.0.2">{{ Auth::user()->user()->inbox_count() }}</span><span
                                            data-reactid=".1.0.0.3">)</span><a href="{{ url('inbox') }}"
                                                                               class="link-reset pull-right see-all"
                                                                               data-reactid=".1.0.0.4">{{ trans('messages.header.view_inbox') }}</a></strong>
                            </div>
                                            ...
                                            <a href="{{ url('z/q')}}/<?php echo $message['reservation_id'];?>">
                                                ...
                                                <a href="{{ url('messaging/qt_with')}}/<?php echo $message['reservation_id'];?>">
                                                    ...
                                                    <img height="50" width="50"
                                                         title="<?php echo $message['user_details']['first_name'];?>"
                                                         src="<?php echo $message['user_details']['profile_picture']['src'];?>"
                                                         class="media-round media-photo"
                                                         alt="<?php echo $message['user_details']['first_name'];?>">
                    ...
                    <ul class="tooltip tooltip-top-right dropdown-menu list-unstyled header-dropdown">
                        ...
                        <li>
                            <a href="{{ url('my_reservations') }}" rel="nofollow"
                               class="no-crawl link-reset menu-item header-reservations">
                                {{ trans('messages.header.reservations') }}
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('users/transaction_history') }}" rel="nofollow"
                               class="no-crawl link-reset menu-item header-transaction">
                                {{ trans('messages.header.transaction_history') }}
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('users/reviews') }}" rel="nofollow"
                               class="no-crawl link-reset menu-item header-reviews">
