...
<!--<![endif]-->
    ...
    <meta property="og:title"
          content="{{ $title or Helpers::meta((!isset($exception)) ? Route::current()->uri() : '', 'title') }} {{ $additional_title or '' }}"/>
...
<body class="{{ (!isset($exception)) ? (Route::current()->uri() == '/' ? 'home_view v2 simple-header p1' : '') : '' }} {{ !Auth::user()->check() ? '' : 'loggedin' }}"
      ng-app="App">
<div class="hide">
