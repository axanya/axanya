                            ...
                            <form class="col-lg-9 trip-form">
                                <div class="row row-condensed">
                                    <div class="col-md-4 col-sm-6 row-space-1-sm">
                                        ...
                                        <input ng-model="checkin" id="checkin" type="text" ng-change="search_result();"
                                               class="checkin tour-target ui-datepicker-target"
                                               placeholder="{{ trans('messages.home.checkin') }}"
                                               ng-init="checkin = '{{ $checkin }}'">
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-6 row-space-1-sm">
                                        ...
                                        <input ng-model="checkout" id="checkout" type="text"
                                               ng-change="search_result();"
                                               class="checkout tour-target ui-datepicker-target"
                                               placeholder="{{ trans('messages.home.checkout') }}"
                                               ng-init="checkout = '{{ $checkout }}'">
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="select select-block">
                                            ...
                                            <select ng-model="guests" class="guest-select" id="guest-select"
                                                    data-prefill="" ng-change="search_result();"
                                                    ng-init="guests = '{{ $guest }}'">
                                    ...
                                    @foreach($room_type as $row=>$value)
                                        <div class="col-middle-alt col-sm-4">
                                            <label class="checkbox panel panel-dark">
                                                <input class="pull-right room-type" type="checkbox"
                                                       ng-model="room_type_{{ $row }}" value="{{ $row }}"
                                                       ng-change="search_result();"
                                                       ng-checked="{{ (in_array($row, $room_type_selected)) }}"
                                                       ng-init="room_type_{{ $row }} = '{{ $row }}'">
                                                @if($row == 1)
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-12">
                                ...
                                <div class="row" style="margin-top: 20px;">
                                    <div class="col-6">
                                        <span> <span>{{ $currency_symbol }}</span> <span class="price"
                                                                                         id="min_text">{{ $min_price }}</span> <span></span></span><input
                                                type="hidden" id="min_value" value="{{ $min_price }}"></div>
                                    <div class="col-6 text-right"><span>
    <span>{{ $currency_symbol }}</span><span class="price" id="max_text">{{ $max_price }}
                                                +</span><span></span></span><input type="hidden" id="max_value"
                                                                                   value="{{ $max_price }}">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row row-condensed">
                                        <div class="col-md-4 col-sm-12 row-space-1">
                                            <div class="select select-block">
                                                ...
                                                <select name="min_bedrooms" ng-model="bedrooms" class="min-bedrooms"
                                                        id="map-search-min-bedrooms"
                                        ...
                                        <div class="col-md-4 col-sm-12 row-space-1">
                                            <div class="select select-block">
                                                ...
                                                <select name="min_bathrooms" ng-model="bathrooms"
                                                        class="min-bathrooms input-medium" id="map-search-min-bathrooms"
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="select select-block">
                                                ...
                                                <select name="min_beds" ng-model="beds" class="min-beds input-medium"
                                                        id="map-search-min-beds" ng-init="beds = '{{ $beds }}'">
          ...
          <span>
            ...
            <strong class="text-muted show-sm">+ {{ trans('messages.profile.more') }}</strong>
                        ...
                        <div class="checkbox-group property_type_id filters-section panel-body panel-light toggle-group"
                                    ...
                                    <div class="row row-condensed filters-columns">
                                        ...
                                        @foreach($property_type as $row_property_type =>$value_property_type)
                                            @if($pro_inc <= 3)
                                                ...
                                                <div class="col-md-4">
                                                    <label class="media checkbox text-truncate"
                                                           title="{{ $value_property_type }}">
                                                        <input type="checkbox"
                                                               ng-model="property_type_{{ $row_property_type }}"
                                                               value="{{ $row_property_type }}"
                                                               class="pull-left property_type"
                                                               id="map-search-property_type-{{ $row_property_type }}"
                                                               ng-checked="{{ (in_array($row_property_type, $property_type_selected)) ? 'true' : 'false' }}">
                                                        {{ $value_property_type}}
                                                    </label>
                                                </div>
                                            @endif
                ...
                <div class="search-results toggle-hide">
                    <div class="outer-listings-container row-space-2">
                        ...
                        <div class="listings-container">
                            <div class="row">
                                ...
                                <div class="col-sm-12 row-space-2 col-md-6" ng-repeat="rooms in room_result.data"
                                     ng-cloak>
                                    <div class="listing list_view" ng-mouseover="on_mouse($index);"
                                        ...
                                        <div class="panel-image listing-img">
                                                ...
                                                <div class="summary">
                                                    <p>
                                                        ...
                                                        <a href="{{ url('s') }}/@{{ location }}?checkin=@{{ checkin }}&checkout=@{{ checkout }}&guests=@{{ guests }}"
                                                           ...
                                                           class="learn-more">{{ trans('messages.search.learn_more') }}</a>
                                                    </p>
                                               ...
                                               target="listing_@{{ rooms.id }}" class="media-photo media-cover">
                                                <div class="listing-img-container media-cover text-center">
                                                    <img id="rooms_image_@{{ rooms.id}}"
                                                         src="{{ url() }}/images/@{{ rooms.photo_name }}"
                                            ...
                                            <a href="{{ url('rooms') }}/@{{ rooms.id }}?checkin=@{{checkin}}&checkout=@{{checkout}}&guests=@{{ guests }}"
                                               target="listing_@{{ rooms.id }}"
                                               class="link-reset panel-overlay-bottom-left panel-overlay-label panel-overlay-listing-label">
                                                <div>
                                                    <sup class="h6 text-contrast"><span
                                                                ng-bind-html="rooms.rooms_price.currency.symbol"></span></sup>
                                                    ...
                                                    <span aria-label="Book Instantly" data-behavior="tooltip"
                                                          class="h3 icon-beach"
                                                          ng-if="rooms.booking_type == 'instant_book'">
                      <i class="icon icon-instant-book icon-flush-sides"></i>
                  </span>
                                                </div>

                                            </a>
                                            <span title="This house is Kosher" class="h3 icon-k hastooltip"
                                                  ng-if="rooms.koshire == '1'">K</span>
                  ...
                  <span class="rich-toggle wish_list_button wishlist-button not_saved">
                    ...
                    <label for="wishlist-widget-@{{ rooms.id }}" class="hide-sm">
                      ...
                      <i class="icon icon-heart-alt icon-white icon-size-2" id="wishlist-widget-icon-@{{ rooms.id }}"
                         data-room_id="@{{ rooms.id }}" data-img="{{ url('images') }}/@{{ rooms.photo_name }}"
                         data-name="@{{ rooms.name }}" data-address="@{{ rooms.rooms_address.city }}"
                         ...
                         data-bedrooms_string="" data-space_tab_content="" data-neighborhood_tab_content=""></i>
                                        ...
                                        <div class="panel-body panel-card-section">
                                            <div class="media">
                                                <a href="{{ url('users/show/') }}/@{{ rooms.user_id }}"
                                                ...
                                                <div itemprop="description"
                                                     class="text-muted listing-location text-truncate"><a
                                                            href="{{ url('rooms') }}/@{{ rooms.id }}?checkin=@{{ checkin }}&checkout=@{{ checkout }}&guests=@{{ guests }}"
    ...
    <span class="open-content">
      <i class="icon icon-globe"></i> {{ trans('messages.search.language_currency') }}
            ...
            <div class="col-lg-12 col-md-12 map-content">
                <div class="col-lg-3 col-md-3" ng-repeat="place_info in places_info track by $index"
                     ng-bind-html="place_info">
                                                ...
                                                <strong>
                                                    <div class="pull-left text-lead va-container va-container-v">
                                                        <input type="text"
                                                               ...
                                                               value="" placeholder="Name Your Wish List">
                                                    </div>
