                ...
                <div class="col-md-9">
                    ...
                    <div id="change_your_password" class="panel row-space-4">
                        ...
                        <div class="panel-body">
                            ...
                            <input id="redirect_on_error" name="redirect_on_error" type="hidden"
                                   value="/users/security?id=33661974">
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="row row-condensed row-space-2">
                                        ...
                                        <div class="col-md-7">
                                            <input class="input-block" id="old_password" name="old_password"
                                                   type="password">
                                            @if ($errors->has('old_password')) <p
                                                    class="help-block text-danger">{{ $errors->first('old_password') }}</p> @endif
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="row row-condensed row-space-2">
                                        ...
                                        <div class="col-7">
                                            <input class="input-block" data-hook="new_password" id="new_password"
                                                   name="new_password" size="30" type="password">
                                            @if ($errors->has('new_password')) <p
                                                    class="help-block text-danger">{{ $errors->first('new_password') }}</p> @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="row row-condensed row-space-2">
                                        ...
                                        <div class="col-md-7">
                                            <input class="input-block" id="user_password_confirmation"
                                                   name="password_confirmation" size="30" type="password">
                                            @if ($errors->has('password_confirmation')) <p
                                                    class="help-block text-danger">{{ $errors->first('password_confirmation') }}</p> @endif
                                        </div>
                                    </div>
                                </div>
