...
@section('emails.main')
  ...
  <span style="margin:0;padding:0;font-family:&quot;Helvetica Neue&quot;,&quot;Helvetica&quot;,Helvetica,Arial,sans-serif">
      We have {{ $currency_symbol }}{{ $payout_amount }} for you but we need you to tell us where to send it. Please log in to your {{ $site_name }}
      account and <a href="{{ $url.('users/payout_preferences/'.$user_id) }}"
                     ...
                     target="_blank">add a payout method</a>.
    </span>
        </div>
    </div>
@stop