                    ...
                    @if($owner)
                        <div class="social-share-cta alert text-center row-space-top-2 row-space-6">
                            <h5 class="text-center">
                                ...
                                {{ trans('messages.rooms.share') }} ‘{{ $result[0]->name }}
                                ’ {{ trans('messages.wishlist.with_friends') }}!

                                <span class="social-share-widget-container icon-kazan text-kazan"><div
                                            class="social-share-widget"><span class="share-title">{{ trans('messages.rooms.share') }}
                                            :</span>
<span class="share-triggers"><a class="share-btn share-facebook-btn link-icon"
                                href="http://www.facebook.com/sharer.php?u={{ url('wishlists/'.$result[0]->id) }}"><i
                class="icon icon-facebook h4"></i>
</a><a class="share-btn share-twitter-btn link-icon"
       href="https://twitter.com/intent/tweet?source=tweetbutton&amp;text=Wow.+I+love+this+Wish+List+on+%40{{ $site_name }}+%23lovemywishlist&amp;url={{ url('wishlists/'.$result[0]->id) }}&amp;original_referer={{ url('wishlists/'.$result[0]->id) }}"><i
                class="icon icon-twitter h4"></i>
                    ...
                    <div class="top-bar row row-table row-space-4">
                        <div class="col-6 col-middle">
                            ...
                            <div class="media">
                                <a href="{{ url() }}/users/show/{{ $result[0]->user_id }}"
                                   class="pull-left media-photo media-round"
                                   title="{{ $result[0]->users->first_name }}">

                                    <img src="{{ $result[0]->profile_picture->src }}"
                                         alt="{{ $result[0]->users->first_name }}" width="50" height="50">
                                    ...
                                    <div class="row row-table wishlist-header-text">
                                        <div class="col-12 col-middle">
                                            <a href="{{ url() }}/users/{{ $result[0]->user_id }}/wishlists" class="h4">
                                                ...
                                                ’s {{ trans_choice('messages.header.wishlist', 2) }}
                                            </a>
                                            <div>
                                                ...
                                                @if($owner)
                                                    <a href="javascript:void();"
                                                       class="edit-button">{{ trans('messages.reviews.edit') }}</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-6 col-middle text-right">
                            ...
                            <div class="btn-group view-btn-group">
                                <button class="btn" data-view="list" disabled="disabled"
                                        id="list">{{ trans('messages.wishlist.list_view') }}</button>
                                <button class="btn" data-view="map"
                                        id="map">{{ trans('messages.wishlist.map_view') }}</button>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="slideshow-container">
                                                <div class="listing_slideshow_thumb_view">
                                                    <div class="listing-slideshow">
                                                        <img src="{{ url('images/'.$row->rooms->photo_name) }}" alt=""
                                                             width="216" height="144"
                                                             style="position: absolute; top: 0px; left: 0px; z-index: 1; opacity: 1; display: inline;"
                                                             id="wishlist_image_{{ $row->room_id }}" rooms_image="">
                                                    </div>
                                                    ...
                                                    <a href="javascript:void();" data-prevent-default=""
                                                       class="photo-paginate prev marker_slider"
                                                       data-room_id="{{ $row->room_id }}"><i></i></a>
                                                    <a href="javascript:void();" data-prevent-default=""
                                                       class="photo-paginate next marker_slider"
                                                       data-room_id="{{ $row->room_id }}"><i></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-9">
                                            <div class="room-info row row-space-2">
                                                <div class="col-9">
                                                    <h2 class="h3 row-space-1"><a
                                                                href="{{ url() }}/rooms/{{ $row->room_id }}">{{ $row->rooms->name }}</a>
                                                    </h2>
                                            ...
                                            @if($owner)
                                                <div class="row">
                                                    <div class="media col-8">
                                                        ...
                                                        <img src="{{ $row->profile_picture->src }}"
                                                             alt="{{ $row->users->first_name }}"
                                                             class="pull-left img-round" width="28" height="28">

                                                        <form id="add-note-form"
                                                              class="note-container media-body text-right"
                                                              data-room_id="{{ $row->room_id }}">
                                                            <textarea name="note" id="note_{{ $row->room_id }}"
                                                                      class="row-space-2"
                                                                      placeholder="{{ trans('messages.wishlist.add_note') }}">{{ $row->note }}</textarea>
                                                    ...
                                                    <div class="col-4">
                                                        <div class="btn-group pull-right wish_list_button_container">
                                                            @if($owner)
                                                                <a class="btn gray remove_listing_button"
                                                                   data-room_id="{{ $row->room_id }}">
                ...
                <div class="edit_view row-space-8" style="display:none;">
                    <div class="row row-space-4">
                        <div class="col-12">
                            <div class="media">
                                ...
                                <a href="{{ url() }}/users/{{ $result[0]->user_id }}/wishlists"
                                   class="media-photo media-round pull-left"
                                   title="{{ $result[0]->users->first_name }}">
                                    <img src="{{ url($result[0]->users->profile_picture->src) }}"
                                         alt="{{ $result[0]->users->first_name }}" width="50" height="50">
                                </a>
                                ...
                                <div class="media-body">
                                    <div class="row row-table wishlist-header-text">
                                        <div class="col-12 col-middle">
                                            <span>{{ trans('messages.reviews.edit') }} {{ trans_choice('messages.header.wishlist', 1) }}
                                                :</span>
                                            <strong></strong>
                                        </div>
                                    </div>
                    ...
                    <div class="wishlists-body row">
                        <div class="col-4">
                            <div class="panel">
                                <a href="{{ url() }}/wishlists/{{ $result[0]->id }}"
                                   class="panel-image media-photo media-link media-photo-block wishlist-unit">
                                    <div class="media-cover media-cover-dark wishlist-bg-img"
                                         style="background-image:url('{{ url('images'.'/'.@$result[0]->saved_wishlists[0]->rooms->photo_name) }}');">
                                    </div>
                        ...
                        <div class="col-8">
                            <form action="{{ url('edit_wishlist/'.$result[0]->id) }}" method="post">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-8">
                                                        ...
                                                        <input id="wish-list-name" name="name"
                                                               value="{{ $result[0]->name }}" type="text">
                                                    </div>
                                                    <div class="col-4">
                                                        ...
                                                        <div class="media">
                                                            <div class="media-body">
                                                                <div class="select select-block"
                                                                     id="wishlist-edit-privacy-setting">
                                                                    <select name="privacy">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="submit"
                                                class="btn btn-primary">{{ trans('messages.wishlist.save_changes') }}</button>
                                        <button class="btn cancel">{{ trans('messages.your_reservations.cancel') }}</button>
                                        <a href="javascript:void();"
                                           class="delete pull-right">{{ trans('messages.lys.delete') }} {{ trans_choice('messages.header.wishlist', 1) }}</a>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <div class="modal-table">
                <div class="modal-cell">
                    <div class="modal-content">
                        ...
                        <form class="email-collaborators" action="{{ url() }}/share_email/{{ $result[0]->id }}"
                              method="post">
                            {!! Form::token() !!}
                            <section class="panel-body">
                                <label class="space-top-2" for="message">{{ trans('messages.wishlist.send_to') }}
                                    :</label>
                                <div class="email-input-typeahead-container" data-typeahead-type="recent"
                                     data-email-tagging="true">
                                    <ul class="input-tag-list list-unstyled list-inline clearfix">
                                        <li class="input-list-item pull-left">
<span class="twitter-typeahead" style="position: relative; display: inline-block;">
<input type="text" class="typeahead tt-input" autocomplete="none" name="email"
       placeholder="{{ trans('messages.wishlist.email_address_placeholder') }}" spellcheck="false" dir="auto"
...
<div class="tt-dataset tt-dataset-email-typeahead">
                                ...
                                <label class="space-top-2" for="message">{{ trans('messages.wishlist.write_message') }}
                                    :</label>
                                <textarea name="message"
                                          rows="3">{{ trans('messages.wishlist.checkout_places') }} {{ $site_name }}
                                    !</textarea>
                            </section>
                            <footer class="panel-footer">
                                <button type="submit"
                                        class="btn btn-primary">{{ trans('messages.wishlist.send_email') }}</button>
                            </footer>
                        </form>
                    </div>
                </div>
