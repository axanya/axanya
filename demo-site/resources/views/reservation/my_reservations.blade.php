                    ...
                    <div class="panel" id="print_area">
                        ...
                        @elseif($reservations->count() == 0 && $code == 1)
                            <div class="panel-body">
                                ...
                                <a href="{{ url() }}/rooms/new" class="btn btn-special list-your-space-btn"
                                   id="list-your-space">{{ trans('messages.your_listing.add_new_listings') }}</a>
                            </div>
                        @else
                                ...
                                <div class="row row-table">
                                    ...
                                    <div class="col-md-6 col-middle">
                                        ...
                                        <a class="btn pull-right"
                                           href="{{ url() }}/my_reservations?all={{ $code }}&amp;print={{ $code }}">
                                            ...
                                            <td>
                                                <div class="media va-container">
                                                    <a class="pull-left media-photo media-round"
                                                       href="{{ url() }}/users/show/{{ $row->users->id }}">
                                                        <span title="{{ $row->users->first_name }}"
                                                              style="baclground-image:url({{ $row->users->profile_picture->src }}); width:50px; height:50px;"></span>
                                                    </a>
                                                    <div class="va-top">
                                                        <a class="text-normal"
                                                           href="{{ url() }}/users/show/{{ $row->users->id }}">{{ $row->users->full_name }}</a>
                                                        <br>
                                                        @if($row->status == 'Accepted')
                                                            <a href="{{ url() }}/messaging/qt_with/{{ $row->id }}"
                                                               class="text-normal">
                                                            ...
                                                            <i class="icon icon-question"
                                                               id="anonymous-email-118017996-tooltip-trigger"></i>
                                                        @endif
                                                        <br>
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                ...
                                                <ul class="list-unstyled">
                                                    ...
                                                    @if($row->status == "Accepted")
                                                        <li>
                                                            <a target="_blank"
                                                               href="{{ url() }}/reservation/itinerary?code={{ $row->code }}">{{ trans('messages.your_reservations.print_confirmation') }}</a>
                                                        </li>
                                                        @if(!$row->checkout_cross)
                                                            <li>
                                                                <a href="#"
                                                                   id="{{$row->id}}-trigger">{{ trans('messages.your_reservations.cancel') }}</a>
                                                            </li>
                                                        @endif
                                                    @endif
                                                </ul>
            ...
            <div class="modal-table">
                <div class="modal-cell">
                    <div class="modal-content">
                        <form accept-charset="UTF-8" action="{{ url('reservation/host_cancel_reservation') }}"
                                ...
                                <div id="decline_reason_container">
                                    ...
                                    <div class="select">
                                        <select id="cancel_reason" name="cancel_reason">
                                            ...
                                            <option value="offer_a_different_listing">I want to offer a different
                                                listing or change the price
                                            </option>
