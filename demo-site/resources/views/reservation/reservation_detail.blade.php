...
@section('main')
    ...
    <i class="icon icon-time"></i>
            ...
            <span class="countdown_timer hasCountdown"><span class="countdown_row countdown_amount"
                                                             id="countdown_1"></span></span>
  </span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div id="accept_decline" class="panel-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $result->rooms->name }}
                                        <a href="{{ url() }}/rooms/{{ $result->room_id }}" class="pull-right"
                                           data-popup="true">{{ trans('messages.your_reservations.view_property') }}</a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        {{ $result->checkin_dmy }}
                                        <a href="{{ url() }}/manage-listing/{{ $result->room_id }}/calendar"
                                           class="pull-right"
                                           data-popup="true">{{ trans('messages.your_reservations.view_calendar') }}</a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $result->cancellation }}
                                        <a href="{{ url() }}/home/cancellation_policies" class="pull-right"
                                           id="cancel-policy-modal-trigger">{{ trans('messages.your_reservations.view_policy') }}</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <i class="icon icon-question icon-question-sign" data-behavior="tooltip"
                                           rel="tooltip" style="font-size: "
                                           aria-label="Different rates apply to different dates.&lt;br /&gt;Please review the property description page for more details."></i>
                                    </td>
                                    <td>
                                ...
                                @if($result->host_fee)
                                    <tr>
                                        <td>
                                            ...
                                            <i class="icon icon-question icon-question-sign" data-behavior="tooltip"
                                               rel="tooltip" style="font-size: "
                                               aria-label="{{ trans('messages.your_reservations.host_fee_desc',['site_name'=>$site_name]) }}"></i>
                                        </td>
                                        <td>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-4">
                                    <span class="media-round"
                                          style="background-image:url({{ $result->users->profile_picture->src }}); width:215px; height:215px;"
                                          title="{{ $result->users->first_name }}"></span>
                                    <h4>
                                        <a href="{{ url() }}/users/show/{{ $result->users->id }}"
                                           class="verification_user_name">{{ $result->users->first_name }}</a>
                                ...
                                <div class="col-8">
                                    <div class="panel panel-quote panel-dark row-space-4">
                                        <div class="panel-body">
                                            ...
                                            <a href="{{ url() }}/messaging/qt_with/{{ $reservation_id }}"
                                               class="view_message_history_link"
                                               target="_blank">{{ trans('messages.your_reservations.view_msg_history') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <i class="icon icon-time"></i>
            ...
            <div class="modal-table">
                <div class="modal-cell">
                    <div class="modal-content">
                        ...
                        <div id="accept-modal-alert"
                             class="panel-header alert alert-header alert-with-icon alert-info hide">
                            <i class="icon icon-comment alert-icon"></i>
                            <span id="alert-content"></span>
                        </div>
                        <form accept-charset="UTF-8" action="{{ url('reservation/accept/'.$reservation_id) }}"
                              id="accept_reservation_form" method="post" name="accept_reservation_form">
                            {!! Form::token() !!}
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-11">
                                        <label class="label-inline"
                                               for="tos_confirm">{{ trans('messages.your_reservations.by_checking_box') }}
                                            <br><a href="{{ url() }}/host_guarantee"
                                                   target="_blank">{{ trans('messages.your_reservations.host_terms_conditions') }}</a>
                                            <br><a href="{{ url() }}/guest_refund"
                                                   target="_blank">{{ trans('messages.your_reservations.guest_refund_terms') }}</a>,
                                            and <a href="{{ url() }}/terms_of_service"
                            ...
                            <div class="panel-footer">
                                ...
                                <input class="btn btn-primary" id="accept_submit" name="commit" type="submit"
                                       value="Accept">
        ...
        <div class="modal" role="dialog" id="decline-modal" aria-hidden="true">
            <div class="modal-table">
                <div class="modal-cell">
                    <div class="modal-content">
                        <form accept-charset="UTF-8" action="{{ url('reservation/decline/'.$reservation_id) }}"
                              id="decline_reservation_form" method="post" name="decline_reservation_form">
                            {!! Form::token() !!}
                            <div class="panel-header">
                                ...
                                <div id="decline_reason_container">
                                    ...
                                    <div class="select">
                                        <select id="decline_reason" name="decline_reason">
                                            ...
                                            <option value="not_comfortable">I do not feel comfortable with this guest
                                            </option>
                                            <option value="not_a_good_fit">My listing is not a good fit for the guest’s
                                                needs (children, pets, etc.)
                                            </option>
                                            <option value="waiting_for_better_reservation">I’m waiting for a more
                                                attractive reservation
                                            </option>
                                            <option value="different_dates_than_selected">The guest is asking for
                                                different dates than the ones selected in this request
                                            </option>
                                    ...
                                    <div id="decline_reason_other_div" class="hide row-space-top-2">
                                        ...
                                        <textarea id="decline_reason_other" name="decline_reason_other"
                                                  rows="4"></textarea>
                                    </div>

                                    <div class="row-space-top-4">
                                        <input type="checkbox" checked="checked" name="block_calendar" value="yes">
                                        {{ trans('messages.your_reservations.block_calc_from') }}
                                        <b>{{ $result->checkin_md }}</b> {{ trans('messages.your_reservations.through') }}
                                        <b>{{ $result->checkout_md }}</b>
                                    </div>
                                </div>
                            ...
                            <div class="panel-footer">
                                ...
                                <input class="btn btn-primary" id="decline_submit" name="commit" type="submit"
                                       value="Decline">
                                <button class="btn" data-behavior="modal-close">
                                    {{ trans('messages.home.close') }}
                                </button>
                ...
                <div class="modal-cell">
                    <div class="modal-content">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="{{ url() }}/messaging/qt_with/{{ $result->id }}"
                                       id="other_reservation_send_message">{{ trans('messages.your_reservations.send_msg_to') }} {{ $result->users->first_name }}</a>
                                </li>
                            </ul>
                            <p></p>
