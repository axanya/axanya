                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div id="hide_penalty">
                                ...
                                <div class="form-group">
                                    <label for="input_before_seven_days" class="col-sm-3 control-label">Cancel Before
                                        Seven Days Checkin</label>
                                    <div class="col-sm-7">
                                        <div class="input-group">
                                ...
                                <div class="form-group">
                                    <label for="input_after_seven_days" class="col-sm-3 control-label">Cancel Less than
                                        Seven Days Checkin</label>
                                    <div class="col-sm-7">
                                        <div class="input-group">
                                ...
                                <div class="form-group">
                                    <label for="input_cancel_limit" class="col-sm-3 control-label">Free Cancelation
                                        Limit</label>
                                    <div class="col-sm-7">
                                        <div class="input-group">
