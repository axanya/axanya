                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="input_paypal_username" class="col-sm-3 control-label">PayPal Username<em
                            ...
                            <div class="form-group">
                                <label for="input_paypal_password" class="col-sm-3 control-label">PayPal Password<em
                                            class="text-danger">*</em></label>

                                <div class="col-sm-6">
                                <!-- {!! Form::text('paypal_password', $result[1]->value, ['class' => 'form-control', 'id' => 'input_paypal_password', 'placeholder' => 'PayPal Password']) !!} -->
                                    <input type="password" value="{{$result[1]->value}}" name="paypal_password"
                                           placeholder="PayPal Password" id="input_paypal_password"
                                           class="form-control">
                            ...
                            <div class="form-group">
                                <label for="input_paypal_signature" class="col-sm-3 control-label">PayPal Signature<em
                                            class="text-danger">*</em></label>
