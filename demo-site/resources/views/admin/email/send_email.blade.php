                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group" id="email_textbox">
                                <label for="input_email" class="col-sm-3 control-label">Email Address<em
                            ...
                            <div class="form-group">
                                <label for="input_subject" class="col-sm-3 control-label">Subject<em
                                            class="text-danger">*</em></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="input_message" class="col-sm-3 control-label">Message (Salutation will be
                                    automatically added)<em class="text-danger">*</em></label>
                                <div class="col-sm-6">
