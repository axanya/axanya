            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-offset-2">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        {!! Form::open(['url' => 'admin/add_coupon_code', 'class' => 'form-horizontal']) !!}
                        <div class="box-body">
                            <span class="text-danger">(*)Fields are Mandatory</span>
                            <div class="form-group">
                                <label for="input_name" class="col-sm-3 control-label">Coupon Code<em
                            ...
                            <div class="form-group">
                                <label for="input_symbol" class="col-sm-3 control-label">Amount<em
                                            class="text-danger">*</em></label>
                            ...
                            <div class="form-group">
                                <label for="input_coupon_currency" class="col-sm-3 control-label">Coupon
                                    Currency</label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="input_expired_at" class="col-sm-3 control-label">Expire Date<em
                                            class="text-danger">*</em></label>
