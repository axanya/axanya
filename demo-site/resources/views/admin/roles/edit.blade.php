                ...
                <div class="col-md-8 col-sm-offset-2">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="input_display_name" class="col-sm-3 control-label">Display Name<em
                                            class="text-danger">*</em></label>
                            ...
                            <div class="form-group">
                                <label for="input_description" class="col-sm-3 control-label">Description<em
                                            class="text-danger">*</em></label>
                                            ...
                                            <li class="checkbox" style="display: inline-block; min-width: 155px;">
                                                <label>
                                                    <input type="checkbox" name="permission[]"
                                                           value="{{ $row->id }}" {{ in_array($row->id, $stored_permissions) ? 'checked' : '' }}>
                                                    {{ $row->display_name }}
                                                </label>
                                            </li>
