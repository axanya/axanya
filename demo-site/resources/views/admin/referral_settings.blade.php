                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label for="input_per_user_limit" class="col-sm-3 control-label">Per User Credit
                                    Limit<em class="text-danger">*</em></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="input_if_friend_guest_credit" class="col-sm-3 control-label">When Friend
                                    Guest<em class="text-danger">*</em></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="input_if_friend_host_credit" class="col-sm-3 control-label">When Friend Host<em
                            ...
                            <div class="form-group">
                                <label for="input_new_referral_user_credit" class="col-sm-3 control-label">New User
                                    Travel Credit<em class="text-danger">*</em></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="input_currency_code" class="col-sm-3 control-label">Currency<em
                                            class="text-danger">*</em></label>
                                <div class="col-sm-6">
