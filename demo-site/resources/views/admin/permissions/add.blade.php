            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-offset-2">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" method="post" action="{{ url('admin/add_permission') }}">
                            {!! Form::token() !!}
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="display_name"
                                               id="input_display_name" placeholder="Display Name">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-default" name="cancel" value="cancel">Cancel
                                </button>
