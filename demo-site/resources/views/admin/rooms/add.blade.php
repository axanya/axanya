                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <div id="sf1" class="frm">
                            ...
                            <fieldset class="box-body">
                                <div class="form-group">
                                    <label for="calendar" class="col-sm-3 control-label">Calendar<em
                            ...
                            <div class="box-footer">
                                <button class="btn btn-primary open1 pull-right" type="button" onclick="next(1)">Next
                        ...
                        <div id="sf2" class="frm">
                            ...
                            <div class="box-footer">
                                <button class="btn btn-warning back2" type="button" onclick="back(2)"><span
                                            class="fa fa-arrow-left"></span> Back
                                </button>
                                <button class="btn btn-primary open2 pull-right" type="button" onclick="next(2)">Next
                                    <span class="fa fa-arrow-right"></span></button>
                            </div>
                        </div>
                        ...
                        <div id="sf5" class="frm">
                            ...
                            <div class="box-footer">
                                <button class="btn btn-warning" type="button" onclick="back(5)"><span
                                            class="fa fa-arrow-left"></span> Back
                                </button>
                                <button class="btn btn-primary pull-right" type="button" onclick="next(5)">Next <span
                                            class="fa fa-arrow-right"></span></button>
                            </div>
                        </div>
                        ...
                        <div id="sf6" class="frm">
                            ...
                            <div class="box-footer">
                                <button class="btn btn-warning" type="button" onclick="back(6)"><span
                                            class="fa fa-arrow-left"></span> Back
                                </button>
                                <button class="btn btn-primary pull-right" type="button" onclick="next(6)">Next <span
                                            class="fa fa-arrow-right"></span></button>
                            </div>
                        </div>
                        ...
                        <div id="sf7" class="frm">
                            ...
                            <fieldset class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="additional_guest" class="col-sm-3 control-label">Additional
                                        Guest</label>
                                    <div class="col-sm-6">
                            ...
                            <div class="box-footer">
                                <button class="btn btn-warning" type="button" onclick="back(7)"><span
                                            class="fa fa-arrow-left"></span> Back
                                </button>
                                <button class="btn btn-primary pull-right" type="button" onclick="next(7)"><span
                                            class="fa fa-arrow-right"></span>Next
                                </button>
                            </div>
                        </div>
                        ...
                        <div id="sf8" class="frm">
                            ...
                            <div class="box-footer">
                                <button class="btn btn-warning" type="button" onclick="back(8)"><span
                                            class="fa fa-arrow-left"></span> Back
                                </button>
                                <button class="btn btn-primary pull-right" type="button" onclick="next(8)"><span
                                            class="fa fa-arrow-right"></span>Next
                                </button>
                            </div>
                        </div>
                        ...
                        <div id="sf9" class="frm">
                            ...
                            <fieldset class="box-body">
                                <div class="form-group">
                                    <label for="cancel_policy" class="col-sm-3 control-label">Cancellation Policy<em
                                                class="text-danger">*</em></label>
                                    <div class="col-sm-6">
                            ...
                            <div class="box-footer">
                                <button class="btn btn-warning" type="button" onclick="back(9)"><span
                                            class="fa fa-arrow-left"></span> Back
                                </button>
                                <button class="btn btn-primary pull-right" type="button" onclick="next(9)"><span
                                            class="fa fa-arrow-right"></span>Next
                                </button>
                            </div>
                        </div>
                        ...
                        <div id="sf10" class="frm">
                            ...
                            <div class="box-footer">
                                <button class="btn btn-warning" type="button" onclick="back(10)"><span
                                            class="fa fa-arrow-left"></span> Back
                                </button>
                                <button class="btn btn-primary pull-right" type="button" onclick="next(10)">Submit
                                </button>
                            </div>
                        </div>
                        <!-- /.box-body -->
