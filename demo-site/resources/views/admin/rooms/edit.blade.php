                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <div id="sf2" class="frm">
                            ...
                            <div class="box-footer">
                                <button class="btn btn-default" type="submit" name="cancel" value="cancel">Cancel
                                </button>
                                            ...
                                            <div class="panel photo-item">
                                                ...
                                                <div class="first-photo-ribbon"
                                                     style="z-index:9; background:none; margin:0; padding:0; "><input
                                                            ...
                                                            @endif name="featured_image"
                                                            class="featured-photo-btn"
                        ...
                        <div id="sf8" class="frm">
                            <div class="box-header with-border">
                                ...
                                <a href="javascript:void(0);" class="btn btn-warning" onclick="step(6)">Photos</a>
                                <a href="javascript:void(0);" class="btn btn-warning" onclick="step(7)">Pricing</a>
                                <a href="javascript:void(0);" class="btn btn-warning" onclick="step(8)" disabled>Booking
                                    Type</a>
                                <a href="javascript:void(0);" class="btn btn-warning" onclick="step(9)">Terms</a>
                            </div>
                            <fieldset class="box-body">
                        ...
                        <div id="sf9" class="frm">
                            <div class="box-header with-border">
                                ...
                                <a href="javascript:void(0);" class="btn btn-warning" onclick="step(7)">Pricing</a>
                                <a href="javascript:void(0);" class="btn btn-warning" onclick="step(8)">Booking Type</a>
                                <a href="javascript:void(0);" class="btn btn-warning" onclick="step(9)"
                                   disabled>Terms</a>
                            </div>
                            <fieldset class="box-body">
                                <div class="form-group">
