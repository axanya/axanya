                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" ng-model="from" ng-change="report(from, to, category)"
                                           class="form-control date" placeholder="From Date">
                                </div>
                                <label class="col-sm-1 control-label">To</label>
                                <div class="col-sm-2">
                                    <input type="text" ng-model="to" ng-change="report(from, to, category)"
                                           class="form-control date" placeholder="To Date">
                                </div>
                                <label class="col-sm-1 control-label">Category</label>
                                <div class="col-sm-2">
                                    <select class="form-control" ng-model="category"
                                            ng-change="report(from, to, category)">
                        ...
                        <div class="text-center" id="print_footer"
                             ng-show="users_report.length || rooms_report.length || reservations_report.length">
                            <a class="btn btn-success" id="export"
                               href="{{ url('admin/reports/export') }}/@{{ from }}/@{{ to }}/@{{ (category) ? category : 'users' }}"><i
                                        class="fa fa-file-excel-o"></i> Export</a>
                            <button class="btn btn-info" ng-click="print(category)"><i class="fa fa-print"></i> Print
                            </button>
                        </div>
                        <br>
                    </div>
