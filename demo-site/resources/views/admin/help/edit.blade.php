                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="input_category" class="col-sm-3 control-label">Category<em
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" id="input_subcategory_id" name="subcategory_id"
                                        ...
                                        <option ng-repeat="item in subcategory"
                            ...
                            <div class="form-group">
                                <label for="input_question" class="col-sm-3 control-label">Question<em
                                            class="text-danger">*</em></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="input_answer" class="col-sm-3 control-label">Answer<em
                                            class="text-danger">*</em></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    {!! Form::radio('suggested', 'yes', ($result->suggested == 'yes') ? true : false) !!}
                                    Yes
                                    {!! Form::radio('suggested', 'no', ($result->suggested == 'no') ? true : false) !!}
                                    No
