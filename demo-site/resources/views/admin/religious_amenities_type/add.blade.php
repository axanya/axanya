                ...
                <div class="col-md-8 col-sm-offset-2">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Religious Amenities Type Form</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        {!! Form::open(['url' => 'admin/add_religious_amenities_type', 'class' => 'form-horizontal']) !!}
                        <div class="box-body">
