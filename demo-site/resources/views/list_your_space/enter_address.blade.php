        ...
        <form id="js-address-fields-form" name="enter_address">
            ...
            <div id="localized-fields">
                <div class="row-space-1">
                    ...
                    <input type="text" placeholder="{{ trans('messages.lys.address1_placeholder') }}"
                           value="{{ $result->address_line_1 }}" class="focus" id="address_line_1" name="address_line_1"
                           autocomplete="off">
                </div>

                <div class="row-space-1">
                    <label for="address_line_2">{{ trans('messages.lys.address_line_2') }}</label>
                    <input type="text" placeholder="{{ trans('messages.lys.address2_placeholder') }}"
                           value="{{ $result->address_line_2 }}" class="focus" id="address_line_2"
                           name="address_line_2">
                </div>
                ...
                <div class="row-space-1">
                    ...
                    <input type="text" placeholder="" class="focus" value="{{ $result->state }}" id="state"
                           name="state">
                </div>

                <div class="row-space-1">
                    <label for="postal_code">{{ trans('messages.lys.zip_postal_code') }}</label>
                    <input type="text" placeholder="" class="focus" value="{{ $result->postal_code }}" id="postal_code"
                           name="postal_code">
                </div>
