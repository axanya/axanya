<div class="manage-listing-content-container" id="js-manage-listing-content-container">
    ...
    <span class="label-contrast label-new
      hide">{{ trans('messages.lys.new') }}</span>
                        <a class="text-normal link-icon" id="js-calendar-settings-btn"
                        ...
                        <footer class="space-top-6 calendar-footer-buttoned">
                            <li>
                                <a href="" class="text-muted"
                                   id="import_button">{{ trans('messages.lys.import_calc') }}</a>
                            </li>
                            <li>
                                <a class="js-calendar-sync text-muted" data-prevent-default="true"
                                   href="{{ url('calendar/sync/'.$result->id) }}">{{ trans('messages.lys.sync_other_calc') }}</a>
                            </li>
                            <li>
                                <a href="" class="text-muted"
                                   id="export_button">{{ trans('messages.lys.export_calc') }}</a>
                            </li>
                        </footer>
                    </div>
                </div>
        ...
        <div id="calendar-rules" class="sidebar-overlay">
            ...
            <div class="sidebar-overlay-inner js-section">
                ...
                <a href="{{ url('manage-listing/'.$room_id.'/calendar') }}" class="modal-close"
                   data-prevent-default=""></a>
                    ...
                    <div id="min-days-select" class="calendar-select">
                        <div class="select                          select-block select-chosen">
                            ...
                            <div class="chosen-container chosen-container-single chosen-container-single-nosearch"
                                 style="width: 279px;" title="" id="select_min_days_notice_chosen"><a
                                        class="chosen-single"
                                        tabindex="-1"><span>{{ trans('messages.lys.are_okay') }}</span>
                                    <div><b></b></div>
                                </a>
                ...
                <div class="row-space-4">
                    ...
                    <div id="turnover-days-select" class="calendar-select">
                        <div class="select                          select-block select-chosen">
                            ...
                            <div class="chosen-container chosen-container-single chosen-container-single-nosearch"
                                 style="width: 279px;" title="" id="select_turnover_days_chosen"><a
                                        class="chosen-single"
                                        tabindex="-1"><span>{{ trans('messages.account.none') }}</span>
                                    <div><b></b></div>
                                </a>
                                <div class="chosen-drop">
                                    <div class="chosen-search"><input type="text" autocomplete="off" readonly=""></div>
                    ...
                    <div id="max-days-select" class="calendar-select">
                        <div class="select select-block select-chosen">
                            <select name="max_days_notice" id="select-max_days_notice" style="display: none;">
                                ...
                                <option value="-1"
                                        selected="selected">{{ trans('messages.lys.guests_arriving_anytime') }}</option>
                            ...
                            <div class="chosen-container chosen-container-single chosen-container-single-nosearch"
                                 style="width: 279px;" title="" id="select_max_days_notice_chosen"><a
                                        class="chosen-single"
                                        tabindex="-1"><span>{{ trans('messages.lys.guests_arriving_anytime') }}</span>
                                    <div><b></b></div>
                                </a>
                                <div class="chosen-drop">
                                    <div class="chosen-search"><input type="text" autocomplete="off" readonly=""></div>
                ...
                <div data-hook="min_max_nights" class="row row-space-2">
                    <div class="col-6">
                        ...
                        <div class="input-addon">
                            <input name="min_nights_input_value" id="min-nights" value="" type="text"
                                   class="input-stem input-large">
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-addon">
                            <input name="max_nights_input_value" id="max-nights" value="" type="text"
                                   class="input-stem input-large">
                            <span class="input-suffix">{{ trans('messages.lys.nights') }}</span>
                        </div>
                    </div>
                ...
                <div data-hook="seasonal_min_max_overview">
                    <div class="row">
                        <div class="col-12">
                            <small>
                                <a href="{{ url('manage-listing/'.$room_id.'/calendar') }}"
                                   class="text-muted link-underline"
                                   data-prevent-default="true">{{ trans('messages.lys.add_requirement_seasons') }}</a>
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="js-calendar-sync-section sidebar-overlay-highlight-section">
                    ...
                    <div></div>
                    <h3 id="calendar_sync_heading" data-hook="calendar_sync_heading"
                        class="row-space-4 sidebar-overlay-heading">
                            ...
                            <div class="row row-condensed">
                                <div class="col-sm-12">
                                    <ul class="list-unstyled" style="margin-bottom:0;">
                                        <li class="space-1">
                                            <a href="{{ url('manage-listing/'.$room_id.'/calendar') }}"
                                               data-prevent-default="true" class="text-muted link-icon">
