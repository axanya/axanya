                        ...
                        <div class="row-space-2 clearfix" id="help-panel-name">
                            <div class="row row-space-top-2">
                                <div class="col-4" style="white-space: nowrap">
                                    <label for="koshire"><input type="checkbox" name="koshire" value="1"
                                                                class="overview-title" id="koshire"
                                                                ng-model="koshire" {{ ($result->koshire == 1) ? 'checked' : '' }} >
                                        {{ trans('messages.lys.kosher') }}<a style="float:right;" target="_blank"
                                                                             href="{{ url('kosher') }}">Kosher</a></label>
