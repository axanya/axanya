...
@section('main')
    ...
    <main id="site-content" role="main" ng-controller="manage_listing">
        ...
        @if($result->status == NULL)
            <div id="js-list-space-tooltip"
                 class="animated tooltip tooltip-bottom-left list-space-tooltip anim-fade-in-up show" aria-hidden="true"
                 style="left: 336px !important; position: fixed; top: 500px !important;">
                <div class="panel-body">
                    <div class="media">
                            ...
                            <div class="listing-card-container">
                                ...
                                <div class="listing">
                                    ...
                                    <div class="panel-image listing-img">
                                        ...
                                        <a class="media-photo media-cover" target=""
                                           href="{{ url('rooms/'.$result->id) }}">
                                            <div class="listing-img-container media-cover text-center">

                                                <img alt="@{{ room_name }}" class="img-responsive-height"
                                                     src="{{ url() }}/images/@{{ popup_photo_name }}" data-current="0"
                                                     itemprop="image">

                                            </div>
                                        </a>

                                        <a class="link-reset panel-overlay-bottom-left panel-overlay-label panel-overlay-listing-label"
                                           target="" href="{{ url('rooms/'.$result->id) }}">
                                            <div>
                                    ...
                                    <div class="panel-body panel-card-section">
                                        <div class="media">
                                            ...
                                            <a class="media-photo-badge pull-right card-profile-picture card-profile-picture-offset"
                                            ...
                                            <h3 class="h5 listing-name text-truncate row-space-top-1" itemprop="name"
                                                title="d">
                                            ...
                                            <div class="text-muted listing-location text-truncate"
                                                 itemprop="description">@{{ popup_room_type_name }} · @{{ popup_state }}
                                                , @{{ popup_country }}</div>
                                        </div>
                                ...
                                <div class="panel-body finish-modal-body">
                                    ...
                                    <div class="col-10 col-offset-1">
                                        <p style="text-align:center;"
                                           class="hide">{{ trans('messages.lys.listing_published_desc1') }}</p>
                                    </div>
                                    <div class="row row-space-top-5">
                                        <div class="col-6">
                                            <a target="_blank" href="{{ url('rooms/'.$result->id) }}"
                                               id="view-listing-button"
                                               class="btn btn-block">{{ trans('messages.lys.view_listing') }}</a>
                                        </div>
                                        <div class="col-6">
                                            <a target="_blank" href="{{ url('rooms/') }}" id="view-listing-button"
                                               class="btn btn-block">{{ trans('messages.lys.manage_listing') }}</a>
                                        </div>
                                        <div class="face_book_icon">
                                            <a class="fb-button fb-blue btn icon-btn btn-block btn-large row-space-1 btn-facebook"
                                               data-network="facebook" rel="nofollow" title="Facebook"
                                               href="http://www.facebook.com/sharer.php?u={{ url('rooms/'.$result->id) }}"
                                               target="_blank">
        ...
        <div tabindex="-1" aria-hidden="{{ ($errors->has('name')) ? 'false' : 'true' }}" role="dialog"
             class="modal show" id="import_popup">
            <div class="modal-table">
                <div class="modal-cell">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <label style="margin-bottom:20px;padding:0;">
                                            ...
                                            <input type="text" value="{{ Input::old('url') }}" name="url"
                                                   placeholder="{{ trans('messages.lys.ical_url_placeholder') }}"
                                                   class="space-1 {{ ($errors->has('url')) ? 'invalid' : '' }}">
                                        ...
                                        <label style="padding:0;margin-bottom:0;">
                                            ...
                                            <input type="text" value="{{ Input::old('name') }}" name="name"
                                                   placeholder="{{ trans('messages.lys.ical_name_placeholder') }}"
                                                   class="space-1 {{ ($errors->has('name')) ? 'invalid' : '' }}">
                                            <span class="text-danger">{{ $errors->first('name') }}</span>
                                        </label>
                                        <div style="margin-top:20px;">
                                            <button name="" data-prevent-default="true" class="btn btn-primary"
