...
class MetasTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('metas')->insert([
            ...
            ['url'         => 'reservation/itinerary',
             'title'       => 'Travel Itinerary, Confirmation Code',
             'description' => 'Travel Itinerary, Confirmation Code',
             'keywords'    => ''
            ],
            ['url'         => 'reservation/requested',
            ...
            ['url'         => 'rooms/new',
             'title'       => 'Rent Out Your Room, House or Apartment',
             'description' => 'Rent Out Your Room, House or Apartment',
             'keywords'    => ''
            ],
            ['url'         => 'manage-listing/{id}/{page}',
             'title'       => 'Edit Listing',
            ...
            ['url'         => 'reservation/receipt',
             'title'       => 'Receipt, Confirmation Code',
             'description' => 'Receipt, Confirmation Code',
             'keywords'    => ''
            ],
            ...
            ['url'         => 'users/payout_preferences/{id}',
             'title'       => 'Account',
             'description' => 'Account',
             'keywords'    => ''
            ],
            ['url'         => 'users/transaction_history',
            ...
            ['url'         => 'users/edit_verification',
             'title'       => 'Trust and Verification',
             'description' => 'Trust and Verification',
             'keywords'    => ''
            ],
            ['url'         => 'in_secure',
             'title'       => 'In Secure Connection',
             'description' => 'In Secure Connection',
             'keywords'    => ''
            ],
        ]);
    }
