...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('permissions')->insert([
            ...
            ['id'           => '34',
             'name'         => 'manage_home_page_sliders',
             'display_name' => 'Manage Home Page Sliders',
             'description'  => 'Manage Home Page Sliders'
            ],
            ['id'           => '35',
             'name'         => 'manage_our_community_banners',
             'display_name' => 'Manage Our Community Banners',
             'description'  => 'Manage Our Communtiy Banners'
            ],
            ['id'           => '36',
             'name'         => 'manage_host_banners',
             'display_name' => 'Manage Host Banners',
             'description'  => 'Manage Host Banners'
            ],
            ['id'           => '37',
             'name'         => 'manage_home_page_bottom_sliders',
             'display_name' => 'Home Page Bottom Sliders',
             'description'  => ' Home Page Bottom Sliders'
            ],
        	]);
    }
}
