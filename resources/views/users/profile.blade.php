            ...
            <div id="slideshow" class="slideshow">
              ...
              <ul class="slideshow-images">
                <li class="active media-photo media-photo-block">
                  <span class="img-responsive"  title="{{ $result->first_name }}" style="height:225px; width:225px; background-image:url({{ $result->profile_picture->src }})"></span>
                </li>
      ...
      <div class="row row-space-4">
        <div class="col-sm-4 show-sm">
          <div class="media-photo media-photo-block media-round">
            <span class="img-responsive" style="background-image:url({{ $result->profile_picture->src }}&width=255&height=255);" title="{{ $result->first_name }}"></span>
          </div>
        </div>
      ...
      <div class="avatar-wrapper">
        <a class="text-muted" href="{{ url() }}/users/show/{{ $row_host->user_from }}">
          <div class="media-photo media-round row-space-1">
            <span style="display: inline; height:68px; width:68px; background-image:url({{ $row_host->users_from->profile_picture->src }})" title="{{ $row_host->users_from->first_name }}" class="lazy"></span>
          </div>
    ...
    <div class="col-md-2 col-sm-12">
      <div class="avatar-wrapper">
        <a class="text-muted" href="{{ url() }}/users/show/{{ $row_guest->user_from }}">
          <div class="media-photo media-round row-space-1">
            <span style="display: inline; height:68px; width:68px; background-image:url({{ $row_guest->users_from->profile_picture->src }});" title="{{ $row_guest->users_from->first_name }}" class="lazy"></span>
          </div>
            <div class="text-center profile-name text-wrap">
