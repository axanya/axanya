...
<div class="ib-better-off-state {{ ($result->booking_type == NULL) ? '' : '' }}" id="before_select" ng-init="booking_type='{{ $result->booking_type }}';">
<div>
<div>
<div>
<h3>
...
<input type="radio" name="booking_type" ng-model= "booking_type" value="request_to_book" ng-click="booking_select('request_to_book')" >
</button>
</div>
<div class="">
...
<input type="radio" name="booking_type" ng-model= "booking_type"  value="instant_book" ng-click="booking_select('instant_book')" >
</button>
</div>
<div class="">
<div class="row row-condensed">
...
<div class="js-ib-state {{ ($result->booking_type == 'request_to_book') ? 'hide' : 'hide' }}" id="request_to_book">
...
<div class="ib-better-off-state {{ ($result->booking_type == 'instant_book') ? 'hide' : 'hide' }}" id="instant_book">
<div>
<div>
<div>
<div class="js-section space-5">
