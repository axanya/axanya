...
</style><div class="col-lg-2 col-md-3 listing-nav-sm nopad pos-fix col-sm-8 min-size" id="js-manage-listing-nav">
...
<li class="nav-item nav-pricing pre-listed" data-track="pricing" ng-class="(step == 'pricing') ? 'nav-active' : ''">
  ...
  <a href="{{ ($room_step != 'calendar') ? url('manage-listing/'.$room_id.'/calendar') : '' }}" class="calendar-popup" id="href_calendar">
    <div class="row nav-item">
      <div class="col-sm-12 va-container">
...
<a href="{{ ($room_step != 'calendar') ? url('manage-listing/'.$room_id.'/calendar') : '' }}" class="inline-calender hide" id="href_calendar"></a>
