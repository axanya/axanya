        ...
        <div class="manage-listing-content" id="js-manage-listing-content"><div>
                <div class="js-section">
                            ...
                            <form name="check_in_check_out" class="">
                                ...
                                <div class="js-section list_inner_frame">
                                    ...
                                    <div class="row row-space-2">
                                        ...
                                        <div class="col-1 rtl-right">
                                          <label class="label-large">&nbsp;&nbsp;</label>
                                          <label class="label-large text-center">{{ trans('messages.lys.separator_to') }}</label>
                                        </div>
                                        <div class="col-4">
                                            <label class="label-large">&nbsp;&nbsp;</label>
                                            <div id="terms-type-select">
                    ...
                    <div class="row-space-top-4">
                      <?php
                      $yes_no_array = [
                        '0' => trans('messages.lys.dropdown_select'),
                        'No' => trans('messages.lys.dropdown_no'),
                        'Yes' => trans('messages.lys.dropdown_yes')
                      ];
                      ?>
                        <div class="list_frame">
                            <div class="list_frame_label">
                            ...
                            <form name="house_rules" class="">
                                ...
                                <div class="js-section list_inner_frame">
                                    ...
                                    <!-- HTML for listing info subsection -->
                                    <div class="row row-space-top-4">
                                        <div class="col-8 rtl-right">
                                            <label class="label-large rtl-text-right">{{ trans('messages.lys.suitable_for_children') }}</label>
                                        </div>
                                        <div class="col-4 rtl-right">
                                            <div id="terms-type-select">
                                                <div class="select select-large select-block">
                                                  <?php
                                                  $attrs = ['id' => 'terms-select-suitable-for-children', 'data-saving' => 'basics3'];
                                                  $attrs['ng-model'] = 'suitable_for_children';
                                                  $attrs['ng-init'] = 'suitable_for_children = "' . ( ( isset( $rooms_policies ) && $rooms_policies->suitable_for_children ) ? $rooms_policies->suitable_for_children : '0' ) . '"';
                                                  $attrs['ng-class'] = 'suitable_for_children == "0" ? "invalid" : ""';
                                                  ?>
                                                    {!! Form::select('suitable_for_children',$yes_no_array, @$rooms_policies->suitable_for_children, $attrs) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row row-space-top-4">
                                        <div class="col-8 rtl-right">
                                            <label class="label-large rtl-text-right">{{ trans('messages.lys.suitable_for_infants') }}</label>
                                        </div>
                                        <div class="col-4 rtl-right">
                                            <div id="terms-type-select">
                                                <div class="select select-large select-block">
                                                  <?php
                                                  $attrs = ['id' => 'terms-select-suitable-for-infants', 'data-saving' => 'basics3'];
                                                  $attrs['ng-model'] = 'suitable_for_infants';
                                                  $attrs['ng-init'] = 'suitable_for_infants = "' . ( ( isset( $rooms_policies ) && $rooms_policies->suitable_for_infants ) ? $rooms_policies->suitable_for_infants : '0' ) . '"';
                                                  $attrs['ng-class'] = 'suitable_for_infants == "0" ? "invalid" : ""';
                                                  ?>
                                                    {!! Form::select('suitable_for_infants',$yes_no_array, @$rooms_policies->suitable_for_infants, $attrs) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row row-space-top-4">
                                        <div class="col-8 rtl-right">
                                            <label class="label-large rtl-text-right">{{ trans('messages.lys.suitable_for_pets') }}</label>
                                        </div>
                                        <div class="col-4 rtl-right">
                                            <div id="terms-type-select">
                                                <div class="select select-large select-block">
                                                  <?php
                                                  $attrs = ['id' => 'terms-select-suitable-for-pets', 'data-saving' => 'basics3'];
                                                  $attrs['ng-model'] = 'suitable_for_pets';
                                                  $attrs['ng-init'] = 'suitable_for_pets = "' . ( ( isset( $rooms_policies ) && $rooms_policies->suitable_for_pets ) ? $rooms_policies->suitable_for_pets : '0' ) . '"';
                                                  $attrs['ng-class'] = 'suitable_for_pets == "0" ? "invalid" : ""';
                                                  ?>
                                                    {!! Form::select('suitable_for_pets',$yes_no_array, @$rooms_policies->suitable_for_pets, $attrs) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row row-space-top-4">
                                        <div class="col-8 rtl-right">
                                            <label class="label-large rtl-text-right">{{ trans('messages.lys.smoking_allowed') }}</label>
                                        </div>
                                        <div class="col-4 rtl-right">
                                            <div id="terms-type-select">
                                                <div class="select select-large select-block">
                                                  <?php
                                                  $attrs = ['id' => 'terms-select-smoking-allowed', 'data-saving' => 'basics3'];
                                                  $attrs['ng-model'] = 'smoking_allowed';
                                                  $attrs['ng-init'] = 'smoking_allowed = "' . ( ( isset( $rooms_policies ) && $rooms_policies->smoking_allowed ) ? $rooms_policies->smoking_allowed : '0' ) . '"';
                                                  $attrs['ng-class'] = 'smoking_allowed == "0" ? "invalid" : ""';
                                                  ?>
                                                    {!! Form::select('smoking_allowed',$yes_no_array, @$rooms_policies->smoking_allowed, $attrs) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row row-space-top-4">
                                        <div class="col-8 rtl-right">
                                            <label class="label-large rtl-text-right">{{ trans('messages.lys.events_parties_allowed') }}</label>
                                        </div>
                                        <div class="col-4 rtl-right">
                                            <div id="terms-type-select">
                                                <div class="select select-large select-block">
                                                  <?php
                                                  $attrs = ['id' => 'terms-select-parties-allowed', 'data-saving' => 'basics3'];
                                                  $attrs['ng-model'] = 'parties_allowed';
                                                  $attrs['ng-init'] = 'parties_allowed = "' . ( ( isset( $rooms_policies ) && $rooms_policies->parties_allowed ) ? $rooms_policies->parties_allowed : '0' ) . '"';
                                                  $attrs['ng-class'] = 'parties_allowed == "0" ? "invalid" : ""';
                                                  ?>
                                                    {!! Form::select('parties_allowed',$yes_no_array, @$rooms_policies->parties_allowed, $attrs) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
