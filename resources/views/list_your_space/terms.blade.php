...
<div class="js-section">
  ...
  <div class="row-space-2">
    ...
    <div id="cancellation-policy-select" class="row-space-2"><div class="select
            select-large
            select-block">
  <select name="cancel_policy" id="select-cancel_policy" data-saving="saving-progress" ng-model="cancel_policy" ng-init="cancel_policy='{{ $result->cancel_policy }}'">
      
      <option value="" {{ ($result->cancel_policy == '') ? 'selected' : '' }}>Select one</option>
...
<div class="not-post-listed row row-space-top-6 progress-buttons">
  ...
  <div  class="animated text-lead text-muted steps-remaining js-steps-remaining show" style="opacity: 1;">
    <div class="col-2 row-space-top-1 next_step">
      <a class="back-section-button" href="{{ url('manage-listing/'.$room_id.'/booking') }}" data-prevent-default="">{{ trans('messages.lys.back') }}</a>
    </div>
  </div>
