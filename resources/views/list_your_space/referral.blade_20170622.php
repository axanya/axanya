            ...
            <div class="row">
              ...
              <div class="col-md-6 col-md-offset-3 col-sm-11 col-sm-offset-1  mt10" ng-init="referral_code='{{ $result->referral_code }}'">
                ...
                <div class="col-sm-8 text-left">
                  <input type="text" class="referral" name="referral_code" ng-model="referral_code" id="referral_code" maxlength="15"  value="{{ $result->referral_code }}" placeholder="Referral Code" data-saving="referral-saving">
                </div>
                ...
                <div class="col-sm-8 text-center">
                  ...
                  <label class="label-large label-inline">
                      <input id="is_referral" type="checkbox" value="0" name="is_referral" data-saving="referral-saving" ng-model="is_referral" ng-init="is_referral = {{ ($result->is_referral == 'No') ? 'true' : 'false' }}" ng-checked="{{ ($result->is_referral == 'No') ? 'true' : 'false' }}">
