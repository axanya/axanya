          ...
          <div class="list_inner_frame">
            ...
            <div class="row">
              ...
              <div class="row-space-2" id="help-panel-direction-helpful-tips">
                ...
                <textarea class="input-large textarea-resize-vertical" name="direction_helpful_tips" rows="4" placeholder="Share direction to your place, and public transportation and picking tips." ng-model="direction_helpful_tips">{{$result->rooms_description->direction_helpful_tips}}</textarea>
              </div>
          ...
          <div class="js-saving-progress saving-progress help-panel-saving" style="display: none;">
            ...
            <div class="row row-space-2">
              <div class="row-space-2" id="help-panel-overview">
                ...
                <textarea class="input-large textarea-resize-vertical" name="overview" rows="4" placeholder="Show people looking at your listing page what make your neighborhood unique." ng-model="overview">{{ $result->rooms_description->overview }}</textarea>
              </div>

              <div class="row-space-2" id="help-panel-getting-arround">
                <label class="label-large">{{ trans('messages.lys.getting_around') }}</label>
                <textarea class="input-large textarea-resize-vertical" name="getting_arround" rows="4" placeholder="You can let travelers know if your listing is close to public transportation (or far from it). You can also mention nearby parking options." ng-model="getting_arround">{{ $result->rooms_description->getting_arround }}</textarea>
              </div>

              <div class="row-space-2" id="help-panel-local-jewish-life">
                <label class="label-large">{{ trans('messages.lys.local_jewish_life') }}</label>
                <textarea class="input-large textarea-resize-vertical" name="local_jewish_life" rows="4" placeholder="Share direction to your place, and public transportation and picking tips." ng-model="local_jewish_life">{{ $result->rooms_description->local_jewish_life }}</textarea>
              </div>
