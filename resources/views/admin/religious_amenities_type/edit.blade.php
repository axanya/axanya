...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Edit Religious Amenities Type
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Religious Amenities Type</a></li>
        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Religious Amenities Type Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => 'admin/edit_religious_amenities_type/'.$result->id, 'class' => 'form-horizontal']) !!}
              <div class="box-body">
