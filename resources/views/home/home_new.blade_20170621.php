        ...
        <div class="hero shift-with-hiw js-hero">
            ...
            <div class="hero__content page-container">
                <div class="textHeaderContainer_1sy11fq text-left">
                    <h1 class="textHeader_1o0y24x" style="text-align: left !important;;">
                        <img src="images/top_homepage.png" style="display:block; margin: 0 !important;">

                        <span>{{ trans('messages.home.text1') }}<br></span>
                        <span>{{ trans('messages.home.text2') }}</span><br>
                        {{--Links--}}
                        <div class="row hero_link_holder" id="link_holder" style="display: none;">
                            <a href="#media-popup" data-media="//www.youtube.com/embed/ZcPBcyEzpAU" class="what-is">
                                <i class="fa fa-play play-ico" aria-hidden="true"></i>    <span class="what-is-link">What is Axanya?</span>
                            </a>
                            <a href="#" class="what-is" id="shareBtn" href="Javascript:void(0)">
                                <i class="fa fa-facebook facebook-ico" aria-hidden="true"></i> <span class="what-is-link">Share with friends</span>
                            </a>
                    ...
                    <div class="page-container">
                        ...
                        <div class="row section-intro text-center row-space row-space-top host_section">
                            ...
                            <div class="col-md-4 col-md-offset-2">
                                ...
                                <p class="sub_text">Set your own nightly rates and receive payments directly
                                to your PayPal or personal bank account.</p>
                            </div>
                            {{--Point--}}
                            <div class="col-md-4">
                                <img src="/images/icons/big_2.png" class="point-ico">
                                <h3 class="point-title">Peace of Mind</h3>
                                <p class="sub_text">Multilayered security, including guest and host profiles,
                                reviews, personal references, and intelligent ID check.</p>
                            </div>
                        </div>
                        {{--Row--}}
                        <div class="row section-intro text-center row-space row-space-top host_section">
                            ...
                            <div class="col-md-4 col-md-offset-2">
                                ...
                                <p class="sub_text">Connect with the global Jewish community, experience places
                                like a local and make new friends.</p>
                            </div>
                            {{--Point--}}
                            <div class="col-md-4">
                                <img src="/images/icons/big_1.png" class="point-ico">
                                <h3 class="point-title">Feel Welcome</h3>
                                <p class="sub_text">Free to be you with whomever you host. Be yourself,
                                wherever you go.</p>
                            </div>
                        </div>
                    </div>
