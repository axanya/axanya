...
<div class="panel-total-charge">
  ...
  <small><div>
    ...
    <span id="fx-messaging">{{ trans('messages.payments.exchange_rate_booking',['symbol'=>'$']) }} {{ $result->rooms_price->currency->original_symbol }}{{ $price_rate }} {{ $result->rooms_price->currency_code }} ({{ trans('messages.payments.host_listing_currency') }}).</span>
  </div></small>
</div>
