...
<span class="img-responsive" style="background-image:url({{ $reservation_details->rooms->users->profile_picture->header_src }});height:60px;width:60px;background-size: cover;display:inline-block;border-radius:50%;" alt="{{ $reservation_details->rooms->users->full_name }}" width="50" height="50" class="media-photo media-round pull-right"></span>
</a>
</div>
</div>
</div>
