...
<div class="panel-body">
  <div class="row">
    ...
    <div class="col-6">
      <div class="media">
        <a href="{{ url() }}/users/show/{{ $reservation_details->user_id }}" class="pull-left media-photo img-round">
		<span style="background-image:url({{ $reservation_details->users->profile_picture->src }}); width:50px; height:50px;" title="{{ $reservation_details->users->first_name }}"></span></a>
